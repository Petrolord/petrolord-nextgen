...
const DashboardPage = () => {
  ...
  return (
    ...
    <Route path="apps/welltest" element={<WellTestLearningPage />} />
    <Route path="apps/welldesign" element={<WellDesignLearningPage />} />
    <Route path="apps/torquedrag" element={<TorqueDragLearningPage />} />
    <Route path="apps/hydraulics" element={<HydraulicsLearningPage />} />
    ...
    <Route path="apps/gaslift" element={<GasLiftLearningPage />} />
    <Route path="apps/esp" element={<EspLearningPage />} />
    <Route path="apps/rodpump" element={<RodPumpLearningPage />} />
    <Route path="apps/gaswell" element={<GasWellLearningPage />} />
    ...
    <Route path="apps/uncertainty" element={<UncertaintyLearningPage />} />
