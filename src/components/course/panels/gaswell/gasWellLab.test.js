...
// tools/course-waves/gaswell/digest.txt, so a lab value that disagrees with that file
...
describe('AGREEMENT WITH THE SHIPPED DIGEST that the 78 lessons quote', () => {
  // A lab value that disagrees with tools/course-waves/gaswell/digest.txt breaks a
