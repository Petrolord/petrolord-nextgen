// EVERY STRING SHAPE A GRADED H1 CAPSTONE ANSWER CAN REACH A LEARNER AS.
//
...
//
// Carried forward from FC9's guard unchanged apart from its names. Where a
...
export const allRenderings = (fields) => {
  if (!Array.isArray(fields) || fields.length !== 18) {
    throw new Error(`[safetystats guard] expected eighteen graded fields, got ${Array.isArray(fields) ? fields.length : typeof fields}`);
  }
