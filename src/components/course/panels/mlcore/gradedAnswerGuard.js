// EVERY STRING SHAPE A GRADED D2 CAPSTONE ANSWER CAN REACH A LEARNER AS.
//
...
export const allRenderings = (fields) => {
  if (!Array.isArray(fields) || fields.length !== 18) {
    throw new Error(`[mlcore guard] expected eighteen graded fields, got ${Array.isArray(fields) ? fields.length : typeof fields}`);
  }
