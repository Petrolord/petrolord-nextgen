...
export const HOME_MODULES = [
  ...
  { key: 'economics', label: 'Economics & Commercial', tagline: 'Cash flow, fiscal regimes, uncertainty, decision analysis, portfolio and field development planning.' },
  { key: 'commercial_trading', label: 'Midstream & Downstream', tagline: 'Crude assay and blending, refinery feasibility and planning.' },
  { key: 'supply_chain', label: 'Supply Chain', tagline: 'Terminals, depots and fuel supply. More courses are coming.' },
