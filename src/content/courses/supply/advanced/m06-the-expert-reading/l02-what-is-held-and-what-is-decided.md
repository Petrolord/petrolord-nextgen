...
| An ocean loss left blank is a missing rate, and the landed total is a floor. | complete false; missing Ocean loss; "A FLOOR: 1 rate(s) not supplied, so the full landed cost is at least this." |
