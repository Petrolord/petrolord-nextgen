...
total gross observed volume: 4581.490 m3. Total standard volume, the closing stock the day is closed on: 4499.452 m3. That total is summed from the unrounded standard volumes. The three printed standard volumes, each rounded to the litre, add to 4499.453 m3, and the day closes on the printed 4499.452 m3.

## Link one: the dip

Each row starts from a tape: 9318 mm, 5406 mm and 1847 mm. The input is a measured height. Left blank or null, it is refused: "No dip reading."
...
On the vertical AK-01, a 250 mm table and a 10 mm table agree at the dip to the litre. On the bullet AK-03, the 100 mm table less the 10 mm table is -0.007 m3 at the dip and 0.120 m3 at 41 mm.
...
Now read AK-03 backwards from its last cell. 51.556 m3 at standard is 52.161 m3 gross observed times a typed 0.988400. By the engine's rule, 52.161 m3 is the volume at the dip less the water, computed from the unrounded volumes, so it is quoted as printed and is not rebuilt from the rounded 52.501 m3 and 0.341 m3. Both volumes came from one table read at 1847 mm and at 41 mm. Every cell traces back to a tape, a table or a typed figure.
