...
This lesson is not written yet. It belongs to advanced module A Step Size Is an Answer (m03-a-step-size-is-an-answer) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows, headings and panel lines are all excluded.
