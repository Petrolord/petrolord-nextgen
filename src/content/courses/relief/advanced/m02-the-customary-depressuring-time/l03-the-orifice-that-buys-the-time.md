...
This lesson is not written yet. It belongs to advanced module The Customary Depressuring Time (m02-the-customary-depressuring-time) and must carry between 500 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows, headings and panel lines are all excluded.
