...
| required area in2 (stated) | refusal | multipleOfT, the engine own second key |
| --- | --- | --- |
...
The third is that it says what to do instead. Alongside the message the engine returns `multipleOfT`, how many of the largest orifice the required area needs, which turns a dead end into the beginning of a design. At 79.000000 in2 the answer is four valves, and at 105.000000 in2 it is five. Know the key's name: a caller that reads only `error` throws that figure away.
