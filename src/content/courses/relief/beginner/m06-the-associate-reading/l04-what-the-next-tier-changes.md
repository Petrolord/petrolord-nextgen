...
This lesson is not written yet. It belongs to beginner module The Associate Reading (m06-the-associate-reading) and must carry between 420 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows, headings and panel lines are all excluded.
