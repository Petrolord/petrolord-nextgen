...
The last column is the whole lesson. The steepest term carries most of the sum at a Reynolds number of 10.000000 and is worth almost nothing by 3000.000000. So the fit has a band it does real work in, and outside that band two of its three coefficients could be almost anything without changing an answer.
...
Read the last row of the table. Above a Reynolds number of about three hundred thousand the clamped and the unclamped corrections part company. The raw fit keeps rising through one and asymptotes to 1.006542523506, and a correction above one would let a viscosity correction add capacity to a valve.
