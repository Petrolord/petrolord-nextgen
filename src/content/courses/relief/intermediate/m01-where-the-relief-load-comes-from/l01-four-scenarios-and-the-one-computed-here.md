...
This lesson is not written yet. It belongs to intermediate module Where the Relief Load Comes From (m01-where-the-relief-load-comes-from) and must carry between 420 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows, headings and panel lines are all excluded.
