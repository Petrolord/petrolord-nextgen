...
The percent is also a whole number the engine has already rounded. planProgress, checklistProgress and programmeProgress each print a percent in this tier, and the lesson quotes each one as the engine prints it.
