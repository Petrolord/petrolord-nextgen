...
k5 is the case to read closely. It is a corrective action on NCR-2026-011, which is Voided. The digest prints: "isCapaOpen reads true and isCapaOverdue reads true, and summarise leaves it out of the open and overdue counts." Asked about k5 alone, the engine says the action is open and overdue. Asked for the dashboard, it leaves k5 out, because the NCR it belongs to has been voided and there is nothing left for the action to fix.
