...
The percent is a whole number the engine has already rounded, and this lesson quotes it as printed. The course states the rounding rule for planProgress: half up on the exact fraction, so 3 of 8 prints 38 and 5 of 8 prints 63. Read 71 as the engine's figure and do not recompute it from the counts.
