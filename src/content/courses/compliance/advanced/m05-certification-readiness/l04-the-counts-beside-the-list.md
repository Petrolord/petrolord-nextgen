...
summarise over the same register prints: clauses 13, applicable 12, excluded 1, evidenced claims 9, unevidenced claims 1, notAssessed 1, reviews overdue 1, reviews due soon 1, audits 6, audits open 2, audits overdue 1, clauses covered 8, never audited 3, stale 1, open findings 3, open major 1, findings overdue 1, open actions 2, overdue actions 1, awaiting an effectiveness check 1.
...
## The records behind three more counts

audits open 2 and audits overdue 1 trace to the ORASHI audits table, which prints each audit's planned end against 2026-10-15:

| audit | type | status | planned end | open | overdue |
| --- | --- | --- | --- | --- | --- |
| ISA-2026-001 | Internal | Reported | 2026-06-12 | true | false |
| ISA-2026-002 | Internal | In progress | 2026-10-09 | true | true |

The other four audits read open false. Of the two open audits, one reads overdue: ISA-2026-001 is Reported, and an audit is overdue only while it is undelivered. ISA-2026-002 is In progress.

awaiting an effectiveness check 1 traces to one action: ac4, Preventive, on ISF-2026-004, Complete with no effectiveness verdict recorded.

## Exercise

At 2026-10-15, read the readiness counts and the summary. Name the pairs that count the same thing under two names. Then take covered 8, neverAudited 3 and staleAudited 1, and say what each one counts and which severity the list gives it, without adding them or forming a percentage. Finally, name the audits behind audits open 2 and audits overdue 1, and say what their statuses show about why the two counts differ.
