...
This lesson takes revision rev-0019-10 of ENG-PRO-0019, the hydrotest procedure. The document's status is In Review, its current revision is '09' and its next revision is '10'. The revision is authored by u-adaeze, and the lesson puts seven requests to the engine. Each answer is ALLOWED or a refusal, and each refusal is quoted exactly as the engine gives it:
