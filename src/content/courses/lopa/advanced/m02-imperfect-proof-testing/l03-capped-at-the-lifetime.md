...
This lesson is not written yet. It belongs to advanced module Imperfect Proof Testing (m02-imperfect-proof-testing) and must carry between 420 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
