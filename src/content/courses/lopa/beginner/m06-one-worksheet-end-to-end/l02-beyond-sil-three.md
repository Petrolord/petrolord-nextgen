...
This lesson is not written yet. It belongs to beginner module One Worksheet, End to End (m06-one-worksheet-end-to-end) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
