...
This lesson is not written yet. It belongs to beginner module A Scenario and Its Frequency (m01-a-scenario-and-its-frequency) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
