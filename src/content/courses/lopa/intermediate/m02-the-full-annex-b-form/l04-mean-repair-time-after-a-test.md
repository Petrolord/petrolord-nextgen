...
This lesson is not written yet. It belongs to intermediate module The Full Annex B Form (m02-the-full-annex-b-form) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
