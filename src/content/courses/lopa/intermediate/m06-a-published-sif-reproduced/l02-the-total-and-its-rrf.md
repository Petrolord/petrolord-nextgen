...
This lesson is not written yet. It belongs to intermediate module A Published SIF, Reproduced (m06-a-published-sif-reproduced) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
