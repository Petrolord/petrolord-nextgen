...
That gap is the defect this course was built after. The layout check measures centre to centre, and a tank icon sits at the centre of its bund, so passing the setback from the EDGE into a centre-to-centre check made every comparison short by half the bund. It failed open, which means it reported a pass on a plot that did not have the room.
...
The crude tank stands 43.1555 m from Transfer pump A and 44.1452 m from Transfer pump B, against a radius of 59.5294 m from the tank centre. Both fail, by 16.3739 m and 15.3842 m. The heater treater at 50.1598 m fails by 9.3696 m, which is a shortfall almost exactly the size of the half-bund that the old check quietly gave away.
