...
The digest names this a SCREENING basis. In its words, the strict basis is the mean average boiling point, which the studio does not compute, and the page labels K as the screening figure.
...
The digest prints K on two T50 readings for each blend, and neither of them is the mean average boiling point.
