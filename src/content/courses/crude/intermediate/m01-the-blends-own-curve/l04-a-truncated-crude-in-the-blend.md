...
Two other answers are available and both would invent data. The engine could treat Ebocha as 0 percent distilled below 110 F, which assumes that none of its light ends exist. Or it could treat it as 100 percent distilled above 920 F, which assumes the rest of the crude boils off at that temperature. Either would give the blend a curve from 75 F to 1350 F, and every cut drawn on it would carry a figure no assay supports.
...
Read the Ebocha partial assay's first and last TBP points, 4 at 110 and 88 at 920, and the blend's first and last points in the table. Say why the blend's curve starts and stops at those two temperatures, and say what the engine would have had to assume about Ebocha to keep the rows at 75, 1030 and 1350 F.
