...
A group cannot say which of its parts is wrong when the group is. It is still a measurement, and this course says so.
...
Name the three kinds of constant and give an example of each. Record the four measured constants with their exported values and the ratio the table prints for each. Then record the three groups and say why the engine cannot be asked for either half of one.
