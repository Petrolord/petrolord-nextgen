...
The engine's own source comments record what changed. There are 9 such comment lines in this module and 59 across the vendored engines, counted by reading the source for a comment line carrying "used to", "no longer" or the repair's own name.
