...
At every step, for the source layer, the engine computes generated mass as potential times the current transformation ratio:
...
Because the potential is constant, the generation history is the TR history rescaled, and you can read the kitchen's schedule straight off it. TR at 120 Ma, before real burial: 0.0028. At 81 Ma, after sixty million years around 90 degrees: 0.0205, the stall making mid-nineties temperatures nearly harmless. At 80 Ma the Upper Shale lands and the step's TR jumps to 0.269: the single most productive megayear in the basin's history, five thousand kilograms per square metre generated during one step, by the instant-deposition convention compressing what the real basin spread over the shale's accumulation. By 60 Ma, TR 0.66; by 20 Ma, 0.7124276686396793. The hot decade adds 0.028; the last ten million years, 0.0018.
...
Compute the mass generated during the hot decade alone, and its share of the total. TR moves from 0.7124276686396793 at 20 Ma to 0.7402699369369322 at 11 Ma: a gain of 0.0278422682972529, times the potential 18786.405883452077 gives 523.06 kg/m2. Against the final 13946.54641524398 that is 3.75 percent of all generation, from the hottest ten megayears the source ever saw. The stall priced this: at TR 0.71 the remaining potential sits in bins that even 168 degrees drains slowly. Erosion's real charge contribution must therefore come from somewhere other than extra generation, which is the next two lessons.
