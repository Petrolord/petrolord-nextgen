...
Given a depth, the curve returns a porosity. Shale porosity at 2000 m is 0.22717481230903933 v/v, and that is one of the six values this tier reports.
...
In 100 m of freshly deposited shale at the surface the solid thickness is 38.57953418711555 m, which is another of the six. Most of that fresh shale is pore space rather than grain, which is the fact the rest of the tier rests on.
...
The fixture is the two layer column: 10 degC at the surface, 0.06 W/m2 of basal heat flow, 1000 m of conductivity 1.8 W/m/K over 1000 m of conductivity 3.5 W/m/K. Its three golden temperatures are 11.666666666666671 degC at the 50 m cell centre, 41.66666666666673 degC at 950 m, and 59.619047619047684 degC at 1950 m.
...
| number | golden value |
|---|---|
| solid thickness in 100 m of surface shale | 38.57953418711555 m |
| 100 m shale from 1000 m, restored to surface | 159.79553483785466 m |
| shale porosity at 2000 m | 0.22717481230903933 v/v |
| temperature at the first cell, 50 m | 11.666666666666671 degC |
| temperature at the low-k base, 950 m | 41.66666666666673 degC |
| temperature at the deepest cell, 1950 m | 59.619047619047684 degC |

The capstone asks for numbers of the same kinds on a case of its own.
...
So this tier stops where the checkable arithmetic stops. When you can produce all six reported numbers and say what each depends on, you have the input every later stage consumes, and you will know when it is wrong.
