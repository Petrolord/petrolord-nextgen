...
Evaluate $0.38 - 0.00004x - 0.00001y$ at increasing distance from the control cluster. On the frame it stays reasonable: 0.32 down to 0.2625, all plausible porosities. At (5000, 2500), 3 km east of the last well: 0.155, half the field's porosity, presented with the same confidence. At (9000, 2500): minus 0.005. NEGATIVE porosity, a physical impossibility, delivered by the same three multiplications that gave the golden probe. Solve for the zero contour: at y 2500 the plane crosses zero at exactly x 8875.
