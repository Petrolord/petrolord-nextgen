...
| 3 | 21333333.33, 21333333.33, 21333333.33 | on the panel | on the panel |
...
For the three-year case this lesson quotes the capex alone, and the panel shows the rest. The count follows the rule the screen states: years in the streams are the construction years plus the operating years.
...
The same care applies to the tax treatment of capital, which the valuation handles. That belongs to the Expert tier, which reads the valuation.
...
Read the capex rows for no construction period, two construction years and three construction years. Quote the capex in each year for each case and the years in the streams where the screen prints it. Then say what stays the same across all three cases and what the construction period changes.
