...
Reading take as the government's share of revenue. Royalty plus tax over 857602518.80 is smaller than 66.1723 percent, and it is the number a press release prints; take is a share of value, and sales are the wrong denominator. The second mistake is to expect the working interest to move it: AKATA prints 66.1723 percent at 100, at 60 and at 25 percent alike, because the share scales the government's lines and the contractor's together and cancels out of the ratio. A ratio that divided a partner's scaled net by the field's unscaled value would climb as the interest fell, a figure about the partnership that says nothing about the regime. The third is to expect take to say something about timing: the one-year depreciation schedule lowers total tax from 148425219.46 to 116025219.46, and take moves only because less was collected; when it was collected plays no part.
