...
Say what each is doing, on module 3's teaching aquifer. The 180 degree angle means half of the ring around the reservoir is in contact with it, which turns a full circle of 12502005731.212427 bbl into a connected wedge of 6251002865.606214 bbl. The compressibility and the initial pressure turn that wedge into an encroachable 102766487.11056614 bbl, under two percent of it. The permeability, thickness, viscosity and radius ratio set how fast that water can move, through a productivity index of 121.38464263682319 bbl/d/psi.
...
**The encroachment angle enters once.** It is applied when the connected wedge is taken, not when the aquifer volume is quoted. Applying it a second time shrinks the encroachable water by a factor of $360/\theta$, 2 on the teaching aquifer, and drags its four step influx down from 23.729965552293255 MMbbl to 12.996048975219418 MMbbl, a fall of 45.233595276064435 percent.
...
It also catches the failure this tier exists to teach. Force a pot aquifer onto the Ekene tank, which has none, and the engine reports a negative oil in place where the honest run gives 12139208.1074968 stb, an aquifer of 42890161.1573930 rb, a water drive index of 1.04254388249892 and a mechanism reading strong water drive. The fit statistic stays above 0.999, which on its own looks healthy.
...
**Influx against encroachable water.** After four steps the teaching aquifer has delivered 23729965.552293256 bbl out of an encroachable 102766487.11056614 bbl, a fraction of 0.23091151813686364. Under a quarter, consistent with an aquifer still supporting pressure. A fraction near or above one is not a strong aquifer, it is a wrong one.
...
Teaching aquifer, Fetkovich, four annual steps on the Ahmed 10-10 pressure history. Diagnostic: not applicable, the geometry and the influx history are given rather than inferred. Geometry: wedge aquifer, 180 degree encroachment, thickness 80 ft, porosity 0.22, permeability 150 md, water viscosity 0.55 cp, total compressibility 0.000006 per psi, reservoir radius 9200 ft, aquifer radius 36800 ft, radius ratio 4. Constants: full circle 12502005731.212427 bbl, connected wedge 6251002865.606214 bbl at an angle fraction of 0.5, encroachable water 102766487.11056614 bbl, productivity index 121.38464263682319 bbl/d/psi, one step decay 0.6931166713789784. Conventions: angle applied once at the wedge, pseudo steady state denominator, midpoint reservoir pressure per step. Result: cumulative influx 23.729965552293255 MMbbl after four steps. Sanity: 0.23091151813686364 of encroachable water delivered, aquifer pressure ending at 2107.3024403049935 psia. A memo on a published case adds one line, the comparison against the printed table, stated to the book's last printed place. Exposure: the aquifer radius and the radius ratio are the least constrained inputs and both act on the encroachable water directly.
...
Second, and this one is uncomfortable on purpose. Take the Ekene pot aquifer result, read it off the panel, and write the most persuasive defence of it you can manage, using only true statements about the run: the fit statistic above 0.999, the drive index closure of exactly 1.00000000000000, the strong water drive classification. Then write the single sentence a reviewer needs to dismantle it. Notice how short it is, and notice that it is the one from section one.
