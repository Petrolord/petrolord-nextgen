...
**The validation tier does not react to your run.** Force a pot aquifer onto Ekene, which has no aquifer, and the engine reports a negative oil in place, a physically impossible number. The tier still reads benchmark verified, and no new warning appears. The tier is a statement about whether the oil and pot aquifer path has been checked against a published example. It is not a statement about whether your case should have used that path. Nothing in the output will tell you that except the negative sign, the drive mechanism reading strong water drive on a tank you know is closed, and your own judgment.
