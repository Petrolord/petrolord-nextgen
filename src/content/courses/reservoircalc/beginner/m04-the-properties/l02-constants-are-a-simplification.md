...
The Expert tier is where the constant porosity goes. It fits a trend surface to the six well porosities, feeds that grid to the same engine in place of the flat 0.20, and reruns the chain at the same contact of 1560 m. The booking comes out above the 12.139208 MMstb the constant produced, by well under a million barrels in the upward direction. The size of that difference is an Expert graded field and this lesson leaves it to be computed there, from the unrounded engine values rather than by subtracting two rounded figures.
