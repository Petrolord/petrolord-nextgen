...
**From this tier, you can say what the seismic can and cannot resolve, with a number.** On the capstone wedge that means a tuning thickness of 16 ms at 25 Hz and 10 ms at 40 Hz, a tuning amplitude of 0.1155947595834732 at both, a tuning amplitude 1.4449345270902185 times the isolated level at the thick end, and a theoretical value of 15.593936024673521 ms that the model was checked against. Behind those six numbers sit the results that transfer: the tuning thickness belongs to the wavelet and the tuning amplitude to the rock, the whole curve is a function of frequency times thickness so one curve serves every frequency, an amplitude in the ambiguous band supports two thicknesses, a peak to trough measurement has a floor at $1.0493/(\pi f)$, and a peak pick on a thin bed is systematically early.
