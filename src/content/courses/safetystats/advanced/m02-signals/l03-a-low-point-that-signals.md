...
Point 4 has 4800000 hours. Convert them to units on the 200,000 hour base, then multiply its lower limit of 0.920345 by those units to find the count that would sit exactly on the limit. Then state the smallest whole number of events that month could have recorded and still not signal, remembering that a signal lies strictly outside the limit. Check your answer in the panel.
