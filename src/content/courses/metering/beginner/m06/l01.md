...
Squaring is the whole story of a budget like this. A contribution and a share of
variance are two different rankings of the same six terms, and the second one is
the one that tells you where money spent on better instrumentation would go.
