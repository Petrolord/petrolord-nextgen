...
The engine still returns a coefficient. It does not refuse, and this is a
deliberate choice worth understanding. Refusing would leave a user with no
number and no explanation of what kind of number was unavailable. Instead the
result carries a warning, in the engine's own words:
