...
A last point on where this sits in the march. The last two rows of the BELEMA march, at outlet pressures of 28.740000 psia and 20.000000 psia, return the regime word `flashing` while the coefficient stays at 19.148480 and the choked flag stays true. The sizing has been capped and the damage mechanism has changed underneath the cap, and only the regime word records the second of those two events.
