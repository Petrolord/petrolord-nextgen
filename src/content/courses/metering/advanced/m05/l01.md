...
The vapour space volume of 12844.2382 ft3 is the same cylinder the rest of this tier works on, taken over the height of the space above the liquid rather than over the whole shell. That is the third time one geometry has produced a different answer in this tier, after the capacity and the wetted area, and it is the reason the losses sit in the same module as the shell and the venting.
