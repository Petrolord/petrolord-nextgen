...
The fire case begins with an area. A pool fire around a tank heats the shell that liquid is standing against, and the heat that gets into the tank is proportional to how much of that wetted shell the flame can reach. Getting the area right is the first half of the calculation, and it is not simply the wetted shell.
