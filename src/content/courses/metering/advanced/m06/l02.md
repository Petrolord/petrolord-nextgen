...
Read the refusal list in digest SECTION 30 and pick any function with more than one refusal against it. Say what distinguishes its two cases, and which of them is an impossible input rather than an absent one.
