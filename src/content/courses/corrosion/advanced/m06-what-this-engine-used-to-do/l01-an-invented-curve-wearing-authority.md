...
The absence is proved three ways and each is a separate check. The region function is not exported, so asking for its type gives undefined. None of the three material guidance strings and neither standard name appears anywhere in the engine source. And no returned string anywhere in three whole screenings names either standard.
