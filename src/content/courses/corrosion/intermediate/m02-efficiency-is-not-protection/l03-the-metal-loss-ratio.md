...
This lesson is not written yet. It belongs to intermediate module Efficiency Is Not Protection (m02-efficiency-is-not-protection) and must carry between 500 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows, headings and panel lines are all excluded.
