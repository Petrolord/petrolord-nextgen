...
This lesson is not written yet. It belongs to beginner module What Is in the Stream (m02-what-is-in-the-stream) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows, headings and panel lines are all excluded.
