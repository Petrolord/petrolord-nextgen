...
"USA - Gulf of Mexico" on the Designer's default project is the cleanest example the sandbox can build. Its royalty is flat at 18.75 percent, its recovery limit is 100 percent, the contractor keeps 100 percent of profit oil, and corporate income tax at 21 percent is the only tax the regime carries, so whatever appears in the tax column is that tax and nothing else.
