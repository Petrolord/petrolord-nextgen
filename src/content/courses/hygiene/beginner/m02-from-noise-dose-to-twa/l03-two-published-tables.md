...
This lesson is not written yet. It belongs to beginner module From Noise Dose to TWA (m02-from-noise-dose-to-twa) and must carry between 460 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
