...
This lesson is not written yet. It belongs to beginner module The Associate Capstone (m06-the-associate-capstone) and must carry between 420 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
