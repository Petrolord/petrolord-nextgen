...
This lesson is not written yet. It belongs to advanced module Errata in the Standards (m04-errata-in-the-standards) and must carry between 500 and 560 PROSE WORDS, counted the way lengths.py counts them: front matter, markdown table rows and panel lines are excluded and HEADINGS ARE COUNTED.
