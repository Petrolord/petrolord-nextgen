...
This tier took the two questions a pressure drop cannot answer, the wall a code demands and the liquid a pig pushes, and then turned round and audited the whole engine. What follows is one pipe answering three different questions.
...
The SOKU pipe at 12.750000 in of outside diameter and 52000.000000 psi of yield needs 0.419231 in of wall at Class 3 and 0.329327 in at Class 1, and the 0.375000 in the mill rolled rates 1019.607843 psig.

## As a volume

It holds 1633.5349 bbl, a sphere crosses it in 2.444444 hours, and at a measured holdup of 0.060000 it delivers 98.0121 bbl to whatever is waiting at the end, every 3.7997 days.

Three answers about one pipe, and not one of them can be derived from the other two. A reader who knows the pressure drop knows nothing about the wall, and a reader who knows the wall knows nothing about the slug.
...
Give the OGBIA line as a hydraulic answer, the SOKU pipe as a pressure envelope and the OGBIA line as a volume, naming the figures for each. Then say why none of the three can be derived from the other two, and list what each of the three audit modules established.
