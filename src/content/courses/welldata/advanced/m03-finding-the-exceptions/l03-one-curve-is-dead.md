...
State the definition of a dead curve in one sentence, then use it to decide three cases: a curve with 0 finite samples in 201, a curve with 1 finite sample in 201, and a curve with 71 nulls of 201. For each, say whether it adds to the dead-curve field. Then answer in two sentences: why does this field count curves when the neighbouring exception fields count files, and what does a value of 1 not tell you.
