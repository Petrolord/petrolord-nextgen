...
| stoichAirKgPerKgFuel | 15.612760 | kg air per kg fuel |
| fuelMolarMassKgKmol | 18.5068 | kg per kmol |

The first figure is on a molar basis and the second on a mass basis. SECTION 11 prints the fuel's molar mass beside them, 18.5068 kg per kmol, and FUEL_REFERENCE carries a molar mass for every component of the analysis. A reader quoting stoichiometric air has to carry the unit with it, because 9.975652 and 15.612760 are the same air stated two ways.
