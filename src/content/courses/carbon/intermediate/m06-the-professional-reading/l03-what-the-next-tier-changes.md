...
This tier ends with figures in three kinds of unit. The heater saved energy: annualEnergySavedGJ 6742.370 on LHV (SECTION 14). The trap lost steam, and with a boiler efficiency and a SYNTHETIC factor it reported fuel and carbon: 355.757 tonnes a year, 1135.851 GJ and 63.721 tCO2e (SECTION 15). The condensate system reported energy, money and carbon: 13230.304 GJ, 175835.28 USD and 742.220 tCO2e a year with treatment priced (SECTION 16). Every one of those figures rests on invented inputs.

None of them is a cost per tonne. This lesson reads where the next tier takes them.

## Two studios, one hand-off

SECTION 1 names the two apps and the engines behind them. The Carbon Footprint & Abatement Studio calls carbonAbatement. The Energy & Utilities Efficiency Studio calls energyEfficiency, and its cost per tonne is carbonAbatement.abatementCost called from inside energyEfficiency.priceSaving.
