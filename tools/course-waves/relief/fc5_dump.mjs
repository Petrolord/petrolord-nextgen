...
//
// Engine, vendored sha-identical with engines 6759621 (carrying the FC5-0 repair, 3bac13cd):
...
w('# Built against engines 6759621, vendored sha-identical over a closure of seven paths. Every figure below is that engine own answer at the inputs named beside it.');
