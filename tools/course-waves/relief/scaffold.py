#!/usr/bin/env python3
"""Scaffold the FC5 relief course into the NextGen repository.
...
COURSE = os.environ.get('FC5_COURSE', '/root/wt-fc5-nextgen/src/content/courses/relief')
DRY = '--dry-run' in sys.argv
MARK = '<!-- FC5 SCAFFOLD PLACEHOLDER: replace this body. Do not change the H1 or the panel line. -->'
...
def body(tier, mkey, mtitle, lkey, ltitle, est, panels, minw):
    ...
    lines += [
        ...
        'the way lengths.py counts them: front matter, markdown table rows and '
        'panel lines are all excluded and HEADINGS ARE COUNTED.',
        '',
        ...
        'comments or the vendored FINDINGS-relief.md, all four of which are provenance '
        'rather than teaching truth.',
        '',
        '## Exercise',
        '',
        'Not written yet.',
...
def main():
    ...
    for tier, mods in S.TIERS.items():
        ...
        manifest = {'app_slug': 'relief', 'tier': tier, 'content_version': 1, 'modules': []}
