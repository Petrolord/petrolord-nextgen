...
# D5_WAVE_DIR and D5_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/appliedai rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${D5_WAVE_DIR:-/root/dai-wip-appliedai}/d5_dump.mjs"
