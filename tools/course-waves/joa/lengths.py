#!/usr/bin/env python3
"""EC9 lesson length gate (adapted from EC8, D5, itself D4, D3, D2, D1 and H1): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'EC9_CONTENT', '/root/wt-ec9-nextgen/src/content/courses/joa')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix="ec9-lengths-")
