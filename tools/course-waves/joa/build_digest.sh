...
# EC9_WAVE_DIR and EC9_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/joa rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${EC9_WAVE_DIR:-/root/cat-wip-joa}/joa_dump.mjs"
