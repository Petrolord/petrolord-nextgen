// fields.json and precision.json: the eighteen graded EC9 fields with the
...
// src/components/course/panels/joa/gradedTolerance.js in the NextGen
// repository, which joa_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/joa_capstone.mjs`, '--json'],
