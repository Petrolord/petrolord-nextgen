#!/usr/bin/env python3
"""THE EC9 TRUTH HARVEST: the kit's harvest_digest.py, then COMMA-GROUPED FIGURES.
...
digest prints (a balance such as "95,024,921.509253")
...
removed; comment lines stay skipped, as in the kit.
    ...
    python3 harvest_joa.py <wave_dir> [digest.txt]
"""
