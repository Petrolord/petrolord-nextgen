...
WHY. The EC9 digest quotes the gazetted texts verbatim (concepts.json, verified
...
wave's BRIEF.md for module coverage.
    ...
    python3 digestpromise_joa.py            run
    python3 digestpromise_joa.py --plant    THE NEGATIVE CONTROL: appends a digest
...
def main():
    ...
    tmp = tempfile.mkdtemp(prefix='ec9-promise-')
    try:
