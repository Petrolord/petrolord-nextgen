#!/usr/bin/env python3
"""RUN EVERY D3 FOUNDATION GATE, WITH ITS NEGATIVE CONTROL, AND PIN WHAT RAN.
...
any other reason still fails the run. D3_STAGE=lessons makes both expect 0.
...
STAGE = os.environ.get('D3_STAGE', 'foundation')
FOUNDATION = STAGE == 'foundation'
# At the foundation, the stub reason each lesson gate must print to count as met.
STUB_REASON = {
    'numsweep_facies.mjs': r'held NOT ONE literal of seven or more significant figures',
...
PY_ORACLE = 'python3'  # the D3 oracle is standard library only
...
RUNS = [
    ...
    ('d3_capstone.mjs', f'{HERE}/d3_capstone.mjs', ['node', f'{HERE}/d3_capstone.mjs'], 0),
    ...
    ('numsweep_facies.mjs', f'{HERE}/numsweep_facies.mjs', ['node', f'{HERE}/numsweep_facies.mjs'], 1 if FOUNDATION else 0),
    ('numsweep_facies.mjs --selftest', f'{HERE}/numsweep_facies.mjs', ['node', f'{HERE}/numsweep_facies.mjs', '--selftest'], 0),
