// fields.json and precision.json: the eighteen graded D3 fields with the
...
// src/components/course/panels/facies/gradedTolerance.js in the NextGen
// repository, which d3_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/d3_capstone.mjs`, '--json'],
