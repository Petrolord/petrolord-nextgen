...
# D3_WAVE_DIR and D3_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/facies rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${D3_WAVE_DIR:-/root/dai-wip-facies}/d3_dump.mjs"
