#!/usr/bin/env python3
"""D3 lesson length gate (adapted from D2's, itself D1's and H1's): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'D3_CONTENT', '/root/wt-dai-d3-nextgen/src/content/courses/facies')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='d3-lengths-')
