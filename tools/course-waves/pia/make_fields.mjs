// fields.json and precision.json: the eighteen graded EC7 fields with the
...
// src/components/course/panels/pia/gradedTolerance.js in the NextGen
// repository, which pia_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/pia_capstone.mjs`, '--json'],
