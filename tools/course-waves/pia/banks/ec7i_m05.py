...
q(0, "The Ekene new onshore lease is run with its stated new-lease rate changed from 15 to 30. What is companies income tax in 2026 under each run?",
 ...
 "PIA s.302(5) makes the hydrocarbon tax non-deductible in determining companies income tax. So a stated rate that doubles the hydrocarbon tax (22711732.336957 to 45423464.673913) leaves companies income tax at 50223464.673913 in both runs. If the tax were deductible the higher reading would lower it; nothing adds the hydrocarbon tax to it either. Companies income tax runs at 30 percent unless stated and needs no reading.")

q(2, "Which stream of revenue does companies income tax charge that the hydrocarbon tax leaves out?",
 "Gas",
 ["Condensate, as a natural gas liquid",
  "Crude oil sold below the fiscal price",
  "Barrels under the production allowance"],
...
q(3, "PIA s.302(11)(a) lets companies income tax deduct \"all rents and royalties the liability for which was incurred by the company during that period in respect of crude oil sold, condensate sold and natural gas sold or delivered or disposed of in any other commercial manner\". Which royalty does that add beyond the hydrocarbon tax base?",
 ...
 ["The royalty by price",
  "The liquids production royalty",
  "Non-associated condensate royalty"],
...
q(3, "PIA s.265(3) says a loss deduction \"shall be made so far as possible from the amount, if any, of the adjusted profit of the first accounting period after that in which the loss was incurred,\". Where does the engine use a loss first?",
 "In the next year",
 ["Same year, against the other class",
  "Spread over the next five years",
  "The ledger's last year"],
...
q(0, "PIA s.265(4) lets a company \"elect in writing that a deduction or any part to be made under this section shall be deferred to and be made in the succeeding accounting period\". How does the engine handle that election?",
 ...
 ["A stated deferral input moves the loss, in whole or in part, to the next year",
  "Every loss is deferred by one year automatically, as the election is the default",
  "It refuses a ledger with a loss until the election is stated in the terms"],
...
q(1, "Which deduction in the hydrocarbon tax base has no counterpart in the companies income tax base?",
 ...
 "The Sixth Schedule production allowance belongs to the hydrocarbon tax alone, and companies income tax has none. Companies income tax has its own capital allowance claim. Section 257(1) makes the HCDT contribution deductible for the hydrocarbon tax and for companies income tax, so both bases take it. Every royalty, the royalty by price included, is deducted for companies income tax under s.302(11)(a).")

q(2, "At what rate does the engine charge companies income tax on an oil and gas company, unless a rate is stated?",
 "30 percent",
 ["The lease's hydrocarbon tax rate",
  "20 percent, as for allowances",
  "0 percent, the small company rate"],
 "Companies income tax runs at 30 percent unless stated; NTA s.56(b) charges \"any other company, at the rate of 30 per cent from the commence- ment of this Act.\" The hydrocarbon tax class does not reach companies income tax: the Ekene new onshore lease pays the same companies income tax under both stated readings. Twenty percent is the yearly capital allowance fraction and no tax rate. The 0 percent rate is for a small company, which an oil and gas producer on these cases is not.")
