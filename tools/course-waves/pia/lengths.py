#!/usr/bin/env python3
"""EC7 lesson length gate (adapted from D5, itself D4, D3, D2, D1 and H1): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'EC7_CONTENT', '/root/wt-ec7-nextgen/src/content/courses/pia')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix="ec7-lengths-")
