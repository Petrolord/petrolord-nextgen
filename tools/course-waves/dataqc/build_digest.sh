...
# D1_WAVE_DIR and D1_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/dataqc rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${D1_WAVE_DIR:-/root/dai-wip-dataqc}/d1_dump.mjs"
