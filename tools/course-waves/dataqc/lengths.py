#!/usr/bin/env python3
"""D1 lesson length gate (adapted from H1's): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'D1_CONTENT', '/root/wt-dai-d1-nextgen/src/content/courses/dataqc')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='d1-lengths-')
