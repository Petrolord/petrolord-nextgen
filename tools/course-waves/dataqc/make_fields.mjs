// fields.json and precision.json: the eighteen graded D1 fields with the
...
// src/components/course/panels/dataqc/gradedTolerance.js in the NextGen
// repository, which d1_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/d1_capstone.mjs`, '--json'],
