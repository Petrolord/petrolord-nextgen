#!/usr/bin/env python3
"""RUN EVERY D1 FOUNDATION GATE, WITH ITS NEGATIVE CONTROL, AND PIN WHAT RAN.
...
PY_ORACLE = 'python3'  # the D1 oracle is standard library only
...
RUNS = [
    ...
    ('d1_capstone.mjs', f'{HERE}/d1_capstone.mjs', ['node', f'{HERE}/d1_capstone.mjs'], 0),
