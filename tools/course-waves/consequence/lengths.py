#!/usr/bin/env python3
"""H4 lesson length gate: PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'H4_CONTENT', '/root/wt-h4-nextgen/src/content/courses/consequence')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='h4-lengths-')
