...
# H4_WAVE_DIR and H4_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/consequence rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${H4_WAVE_DIR:-/root/hse-wip-consequence}/h4_dump.mjs"
