#!/usr/bin/env python3
"""RUN EVERY H4 FOUNDATION GATE, WITH ITS NEGATIVE CONTROL, AND PIN WHAT RAN.
...
NG = os.environ.get('H4_REPO', '/root/wt-h4-nextgen')
...
RUNS = [
    ...
    ('h4_capstone.mjs', f'{HERE}/h4_capstone.mjs', ['node', f'{HERE}/h4_capstone.mjs', '--json'], 0),
    ...
    ('oracle_check.py', f'{HERE}/oracle_check.py', ['/root/hseenv/bin/python3', f'{HERE}/oracle_check.py'], 0),
    ('oracle_check.py NEGATIVE CONTROL', f'{HERE}/oracle_check.py', ['/root/hseenv/bin/python3', f'{HERE}/oracle_check.py', '--plant'], 1),
    ...
    ('gate_capstone_leak.mjs full', f'{HERE}/gate_capstone_leak.mjs', ['node', f'{HERE}/gate_capstone_leak.mjs'], 0),
    ('lengths.py', f'{HERE}/lengths.py', ['python3', f'{HERE}/lengths.py'], 0),
    ('leakage.mjs --banks', f'{KIT}/leakage.mjs', ['node', f'{KIT}/leakage.mjs', HERE, '--banks'], 0),
    ('numsweep.mjs lessons', f'{KIT}/numsweep.mjs', ['node', f'{KIT}/numsweep.mjs', HERE, '--content', f'{NG}/src/content/courses/consequence'], 0),
    ('numsweep.mjs --banks', f'{KIT}/numsweep.mjs', ['node', f'{KIT}/numsweep.mjs', HERE, '--banks'], 0),
    ('litsweep.py lessons', f'{KIT}/litsweep.py', ['python3', f'{KIT}/litsweep.py', HERE, '--prefix', 'h4', '--lessons', f'{NG}/src/content/courses/consequence', '--lessons-only'], 0),
    ('litsweep.py banks', f'{KIT}/litsweep.py', ['python3', f'{KIT}/litsweep.py', HERE, '--prefix', 'h4'], 0),
    ('lengthtails.py h4b', f'{KIT}/lengthtails.py', ['python3', f'{KIT}/lengthtails.py', f'{HERE}/banks', '--prefix', 'h4b', '--refuse', '40'], 0),
    ('lengthtails.py h4i', f'{KIT}/lengthtails.py', ['python3', f'{KIT}/lengthtails.py', f'{HERE}/banks', '--prefix', 'h4i', '--refuse', '40'], 0),
    ('lengthtails.py h4a', f'{KIT}/lengthtails.py', ['python3', f'{KIT}/lengthtails.py', f'{HERE}/banks', '--prefix', 'h4a', '--refuse', '40'], 0),
    ('dupaxes.py h4', f'{KIT}/dupaxes.py', ['python3', f'{KIT}/dupaxes.py', f'{HERE}/banks', '--prefix', 'h4'], 0),
    ('bankleak.py', f'{KIT}/bankleak.py', ['python3', f'{KIT}/bankleak.py', HERE], 0),
    ('bankrepro.py', f'{KIT}/bankrepro.py', ['python3', f'{KIT}/bankrepro.py', f'{HERE}/banks'], 0),
    ('digestprose.mjs lessons', f'{KIT}/digestprose.mjs', ['node', f'{KIT}/digestprose.mjs', f'{HERE}/digest.txt', '--rules', HERE, '--lessons', f'{NG}/src/content/courses/consequence'], 0),
    ('verify_sql.py HEAD', f'{HERE}/verify_sql.py', ['python3', f'{HERE}/verify_sql.py', 'HEAD'], 0),
    ('verify_sql.py NEGATIVE CONTROL', f'{HERE}/verify_sql.py', ['python3', f'{HERE}/verify_sql.py', 'HEAD', '--canary'], 2),
    ('gen_seeds.sh HEAD', f'{HERE}/gen_seeds.sh', ['bash', f'{NG}/tools/course-waves/consequence/gen_seeds.sh', 'HEAD'], 0),
