// fields.json and precision.json: the eighteen graded H4 fields with the
...
// src/components/course/panels/lopa/gradedTolerance.js in the NextGen
// repository, which h4_capstone.mjs and the teaching lab both import. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/h4_capstone.mjs`, '--json'],
