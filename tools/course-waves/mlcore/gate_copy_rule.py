...
any lesson body or manifest title, and in the three D2 panels, their shared bits and the lab
...
APP_TEXT = [os.path.join(REPO, 'src/components/course/panels/mlcore', f) for f in
