#!/usr/bin/env python3
"""D2 lesson length gate (adapted from D1's, itself H1's): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'D2_CONTENT', '/root/wt-dai-d2-nextgen/src/content/courses/mlcore')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='d2-lengths-')
