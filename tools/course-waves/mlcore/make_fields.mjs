// fields.json and precision.json: the eighteen graded D2 fields with the
...
// src/components/course/panels/mlcore/gradedTolerance.js in the NextGen
// repository, which d2_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/d2_capstone.mjs`, '--json'],
