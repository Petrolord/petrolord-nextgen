...
# D2_WAVE_DIR and D2_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/mlcore rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${D2_WAVE_DIR:-/root/dai-wip-mlcore}/d2_dump.mjs"
