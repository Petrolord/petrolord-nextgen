# H1 Safety Performance Statistics & KPIs: the key-truth writer's task
...
1. A rate is a count times a base over exposure hours, and the engine refuses a
   missing base: 0.776317 per 200,000 hours and 3.881586 per 1,000,000 are the
...
7. A count is a draw: at 1 event the 95 percent upper limit is 220.068159 times
   the lower, at 100 events 1.494848 times, on the same observed rate.
8. The Garwood interval uses 2N degrees of freedom below and 2N + 2 above, and it
   never covers less than the nominal level: the lowest coverage the digest
   probes is 0.956795.
...
13. A u-chart's centre line is pooled: 2.893273 on EGBEMA, against a mean of the
...
Digest section 28's vocabulary is binding. No em dashes, no en dashes, no "X, not
Y" contrastive. No key truth may carry a capstone workplace, count, hours or
graded answer at any precision.
