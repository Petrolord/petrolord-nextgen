...
any lesson body or manifest title, and in the three H1 panels, their shared bits
...
APP_TEXT = [os.path.join(REPO, 'src/components/course/panels/safetystats', f) for f in
...
def main():
    ...
    if '--plant' in sys.argv:
        ...
        d += '\nThe pooled rate, not the mean of rates \u2014 always.\n'
