// fields.json and precision.json: the eighteen graded H1 fields with the
...
// src/components/course/panels/safetystats/gradedTolerance.js in the NextGen
// repository, which h1_capstone.mjs and the teaching lab both import. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/h1_capstone.mjs`, '--json'],
