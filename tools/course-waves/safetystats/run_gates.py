#!/usr/bin/env python3
"""RUN EVERY H1 FOUNDATION GATE, WITH ITS NEGATIVE CONTROL, AND PIN WHAT RAN.
...
KIT = '/root/dc-wavekit'
PY_ORACLE = '/root/hseenv/bin/python'
...
RUNS = [
    ...
    ('h1_capstone.mjs', f'{HERE}/h1_capstone.mjs', ['node', f'{HERE}/h1_capstone.mjs'], 0),
