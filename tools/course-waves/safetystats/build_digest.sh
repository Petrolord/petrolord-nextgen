...
# H1_WAVE_DIR and H1_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/safetystats rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${H1_WAVE_DIR:-/root/hse-wip-safetystats}/h1_dump.mjs"
