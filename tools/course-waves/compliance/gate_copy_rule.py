...
REPO = '/root/wt-as-compliance-nextgen/src/content/courses/compliance'
ENGINE_VERBATIM = 'A finding that stopped work is a nonconformity, not an observation.'
...
def main():
    ...
    for name, text in items:
        ...
        for para in re.split(r'\n\s*\n', text):
            ...
            probe = flat.replace(f'"{ENGINE_VERBATIM}"', '').replace('"X, not Y"', '')
