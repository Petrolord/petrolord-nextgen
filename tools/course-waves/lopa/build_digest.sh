...
# H3_WAVE_DIR and H3_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/lopa rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${H3_WAVE_DIR:-/root/hse-wip-lopa}/h3_dump.mjs"
