...
any lesson body or manifest title, and in the three H3 panels, their shared bits
...
APP_TEXT = [os.path.join(REPO, 'src/components/course/panels/lopa', f) for f in
...
def main():
    ...
    if '--plant' in sys.argv:
        ...
        d += '\nThe required PFDavg, not the band \u2014 always.\n'
