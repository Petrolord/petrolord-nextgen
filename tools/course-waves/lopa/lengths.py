#!/usr/bin/env python3
"""H3 lesson length gate: PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'H3_CONTENT', '/root/wt-h3-nextgen/src/content/courses/lopa')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='h3-lengths-')
