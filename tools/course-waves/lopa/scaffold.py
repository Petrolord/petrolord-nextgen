#!/usr/bin/env python3
"""Scaffold the H3 Process Safety: LOPA & SIL Determination course into the NextGen repository.
...
COURSE = os.environ.get('H3_COURSE', '/root/wt-h3-nextgen/src/content/courses/lopa')
DRY = '--dry-run' in sys.argv
MARK = '<!-- H3 SCAFFOLD PLACEHOLDER: replace this body. Do not change the H1 or the panel line. -->'
...
def body(tier, mkey, mtitle, lkey, ltitle, est, panels, minw):
    ...
    lines += [
        ...
        'prints. FINDINGS-lopa.md, the oracle and the engine source comments are '
...
def main():
    ...
    for tier, mods in S.TIERS.items():
        ...
        manifest = {'app_slug': 'lopa', 'tier': tier, 'content_version': 1, 'modules': []}
