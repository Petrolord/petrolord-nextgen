#!/usr/bin/env python3
"""RUN EVERY H3 FOUNDATION GATE, WITH ITS NEGATIVE CONTROL, AND PIN WHAT RAN.
...
NG = os.environ.get('H3_REPO', '/root/wt-h3-nextgen')
...
RUNS = [
    ...
    ('h3_capstone.mjs', f'{HERE}/h3_capstone.mjs', ['node', f'{HERE}/h3_capstone.mjs', '--json'], 0),
    ...
    ('oracle_check.py', f'{HERE}/oracle_check.py', ['python3', f'{HERE}/oracle_check.py'], 0),
    ('oracle_check.py NEGATIVE CONTROL', f'{HERE}/oracle_check.py', ['python3', f'{HERE}/oracle_check.py', '--plant'], 1),
