// fields.json and precision.json: the eighteen graded H3 fields with the
...
// repository, which h3_capstone.mjs and the teaching lab both import. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/h3_capstone.mjs`, '--json'],
