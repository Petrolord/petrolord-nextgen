#!/usr/bin/env python3
"""Compare the three FC6 deep seeds against the 21 bank JSONs, FIELD BY FIELD.
...
REPO = os.environ.get(
    'REPO', UP if os.path.exists(os.path.join(UP, '.git')) else '/root/wt-fc6-nextgen')
SLUG, PREFIX, DATE = 'heattransfer', 'fc6', '20260925'
