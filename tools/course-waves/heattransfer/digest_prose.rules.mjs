...
export default {
  ...
  pinned: [
    ...
    { frag: 'is a design limit this module declares for itself, and no publication sets it', src: 'engines/facilities/heatTransfer.js' },
    ...
    { frag: 'This is a capability that the plant may never draw on', src: 'engines/facilities/heatTransfer.js' },
