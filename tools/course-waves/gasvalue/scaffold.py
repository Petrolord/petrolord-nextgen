#!/usr/bin/env python3
"""Build the gasvalue scaffold in the NextGen worktree from structure.py.
...
file. A placeholder carries no prose and no number, and this script refuses to
write over a lesson that is more than its title line. gate_copy_rule.py sweeps
the manifests and the placeholders.
...
REPO = '/root/wt-et-gasvalue-nextgen'
SLUG = 'gasvalue'
