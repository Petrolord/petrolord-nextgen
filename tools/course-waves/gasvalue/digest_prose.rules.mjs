...
export default {
  ...
  pinned: [
    ...
    { frag: 'No abatement is reported. The flare\\\'s gross emission is not the abatement', src: 'engines/downstream/flareToValue.js' },
    ...
    { frag: 'The hurdle margin is not a number.', src: 'engines/downstream/flareToValue.js' },
    ...
    { frag: 'The rack cannot keep up with arrivals. The queue grows without limit', src: 'engines/downstream/terminalDepot.js' },
