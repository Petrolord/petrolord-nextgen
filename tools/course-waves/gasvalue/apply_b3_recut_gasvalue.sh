#!/usr/bin/env bash
# =============================================================================
# B3 RECUT of the LIVE course gasvalue (Flare Gas to Value & LPG/CNG), content-addressed.
#
# Engines #232 (petrolord-engines e972ae7) recast engine sentences the LIVE
# gasvalue question bank quoted verbatim. These TEXT-ONLY migrations bring the
...
FILES="
20261015_b3_recut_gasvalue_beginner
20261015_b3_recut_gasvalue_intermediate
20261015_b3_recut_gasvalue_advanced
"
digest_for() {
  case $1 in
    20261015_b3_recut_gasvalue_beginner     ) echo 30e29be62faa0ae12c13d5e00a8d29a8cde2fa34ac223a7ae98089108cf6c57c ;;
    20261015_b3_recut_gasvalue_intermediate ) echo c93ed8f30e5968507f5df755f90f673be996de5e2ff3d3bd1ceaed8ac9e9061d ;;
    20261015_b3_recut_gasvalue_advanced     ) echo bca349d5f928c2ceb968072946feccf7f093dfbaa95779542104b47fa4db21a3 ;;
    *) echo UNPINNED ;;
  esac
}
