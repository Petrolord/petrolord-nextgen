#!/usr/bin/env python3
"""SC2 lesson length gate (adapted from D5, itself D4, D3, D2, D1 and H1): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'SC2_CONTENT', '/root/wt-sc2-nextgen/src/content/courses/procurement')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix="sc2-lengths-")
