...
# SC2_WAVE_DIR and SC2_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/procurement rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${SC2_WAVE_DIR:-/root/cat-wip-procurement}/sc2_dump.mjs"
