// fields.json and precision.json: the eighteen graded SC2 fields with the
...
// src/components/course/panels/procurement/gradedTolerance.js in the NextGen
// repository, which sc2_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/sc2_capstone.mjs`, '--json'],
