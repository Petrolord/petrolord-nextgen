#!/usr/bin/env python3
"""THE SC2 TRUTH HARVEST: the kit's harvest_digest.py, then COMMA-GROUPED FIGURES.
...
digest prints (an evaluated cost such as "862,141")
...
removed; comment lines stay skipped, as in the kit.
    ...
    python3 harvest_procurement.py <wave_dir> [digest.txt]
"""
