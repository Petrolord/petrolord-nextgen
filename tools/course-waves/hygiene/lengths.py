#!/usr/bin/env python3
"""H2 lesson length gate: PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'H2_CONTENT', '/root/wt-h2-nextgen/src/content/courses/hygiene')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='h2-lengths-')
