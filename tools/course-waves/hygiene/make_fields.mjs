// fields.json and precision.json: the eighteen graded H2 fields with the
...
// src/components/course/panels/hygiene/gradedTolerance.js in the NextGen
// repository, which h2_capstone.mjs and the teaching lab both import. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/h2_capstone.mjs`, '--json'],
