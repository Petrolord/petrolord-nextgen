#!/usr/bin/env bash
# =============================================================================
# B3 RECUT of the LIVE course supply (Terminals, Depots & Fuel Supply), content-addressed.
#
# Engines #232 (petrolord-engines e972ae7) recast engine sentences the LIVE
# supply question bank quoted verbatim. These TEXT-ONLY migrations bring the
...
FILES="
20261015_b3_recut_supply_intermediate
20261015_b3_recut_supply_advanced
"
digest_for() {
  case $1 in
