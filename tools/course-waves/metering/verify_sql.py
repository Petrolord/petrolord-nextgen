#!/usr/bin/env python3
"""Compare the three FC8 deep seeds against the 21 bank JSONs, FIELD BY FIELD.
...
REPO = os.environ.get(
    'REPO', UP if os.path.exists(os.path.join(UP, '.git')) else '/root/wt-fc8-nextgen')
SLUG, PREFIX, DATE = 'metering', 'fc8', '20260925'
