// fields.json and precision.json: the eighteen graded FC8 fields with the
// tolerance each is graded at. REGENERATED from the generator, never hand
// edited.
//
// THE TOLERANCE IS NOT MADE HERE. It is made in exactly one place,
// src/components/course/panels/metering/gradedTolerance.js in the NextGen
// repository, which fc8_capstone.mjs, discriminate.mjs, gate_collisions.mjs and
// the teaching lab all import. This script writes that one derivation out in
// the two shapes the rest of the programme reads, and REFUSES if any field
// would be graded tighter than its own class prints.
//
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/fc8_capstone.mjs`, '--json'],
