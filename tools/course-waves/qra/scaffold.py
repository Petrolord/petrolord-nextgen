#!/usr/bin/env python3
"""Scaffold the H5 Quantitative Risk Assessment course into the NextGen repository.
...
COURSE = os.environ.get('H5_COURSE', '/root/wt-h5-nextgen/src/content/courses/qra')
DRY = '--dry-run' in sys.argv
MARK = '<!-- H5 SCAFFOLD PLACEHOLDER: replace this body. Do not change the H1 or the panel line. -->'
...
def body(tier, mkey, mtitle, lkey, ltitle, est, panels, minw):
    ...
    lines += [
        ...
        'prints. FINDINGS-qra.md, the oracle and the engine source comments are '
...
def main():
    ...
    for tier, mods in S.TIERS.items():
        ...
        manifest = {'app_slug': 'qra', 'tier': tier, 'content_version': 1, 'modules': []}
