#!/usr/bin/env python3
"""H5 lesson length gate: PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'H5_CONTENT', '/root/wt-h5-nextgen/src/content/courses/qra')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='h5-lengths-')
