...
// src/components/course/panels/qra/gradedTolerance.js in the NextGen
// repository, which h5_capstone.mjs and the teaching lab both import. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/h5_capstone.mjs`, '--json'],
