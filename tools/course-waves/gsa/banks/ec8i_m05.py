...
q(3, "A gas distributor states a negotiated price of 2.9 on a call that states price control applies and the domestic base price reported for 2026. What does the engine return?",
 "A price of 2.680000 held at the ceiling of s.167(7), with the 2.900000 returned as the stated figure",
 ["The stated 2.900000 as the price, with a reason flagging that it breaks the ceiling of s.167(7)",
  "Refused by name at negotiatedPrice, since a negotiated price above the commercial price is not an input",
  "A price of 2.900000 with no reason, because a distributor negotiates its price freely under the Act"],
 "While price control applies, s.167(7) says a distributor's price \"shall not exceed\" the commercial sector price, so the engine holds the price there: its reason reads \"the negotiated price 2.9 exceeds the commercial sector price 2.68, so the price is held at 2.68 (s.167(7))\", and it returns the stated figure as statedPrice with withinCeiling false and heldAt ceiling. The 2.68 is the commercial price on the stated base reported for 2026. The stated figure is no lawful price under s.167(7), so the engine does not return it as the price, and it refuses nothing: the call is valid and the breach is readable beside the price. A distributor negotiates only inside the ceiling while price control applies.")
...
q(3, "A gas distributor's negotiated price is exactly equal to the commercial sector price that the stated 2026 reported base price gives. How does the engine read it?",
 ...
 "The ceiling is inclusive, and on the stated base price reported for 2026 the engine's reason reads \"the negotiated price 2.68 is at or below the commercial sector price 2.68, the ceiling for gas distributors (s.167(7))\". \"Shall not exceed\" allows equality, so the ceiling itself is available. The engine refuses nothing here. The power sector price plays no part in a distributor's price.")
...
q(1, "Someone pricing the power sector under price control also fills in negotiatedPrice with 2. Quote the engine's response.",
