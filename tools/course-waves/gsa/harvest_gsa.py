#!/usr/bin/env python3
"""THE EC8 TRUTH HARVEST: the kit's harvest_digest.py, then COMMA-GROUPED FIGURES.
...
digest prints (a royalty such as "13,625,099")
...
removed; comment lines stay skipped, as in the kit.
    ...
    python3 harvest_gsa.py <wave_dir> [digest.txt]
"""
