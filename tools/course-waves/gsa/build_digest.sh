...
# EC8_WAVE_DIR and EC8_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/gsa rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${EC8_WAVE_DIR:-/root/cat-wip-gsa}/gsa_dump.mjs"
