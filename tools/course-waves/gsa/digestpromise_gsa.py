...
WHY. The EC8 digest quotes the gazetted texts verbatim (concepts.json, verified
...
wave's BRIEF.md for module coverage.
    ...
    python3 digestpromise_gsa.py            run
    python3 digestpromise_gsa.py --plant    THE NEGATIVE CONTROL: appends a digest
...
def main():
    ...
    tmp = tempfile.mkdtemp(prefix='ec8-promise-')
    try:
