#!/usr/bin/env python3
"""EC8 lesson length gate (adapted from D5, itself D4, D3, D2, D1 and H1): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'EC8_CONTENT', '/root/wt-ec8-nextgen/src/content/courses/gsa')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix="ec8-lengths-")
