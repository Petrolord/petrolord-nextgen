#!/usr/bin/env python3
"""Scaffold the FC9 Corrosion & Integrity course into the NextGen repository.
...
MARK = '<!-- FC9 SCAFFOLD PLACEHOLDER: replace this body. Do not change the H1 or the panel line. -->'
...
def body(tier, mkey, mtitle, lkey, ltitle, est, panels, minw):
    ...
    lines += [
        ...
        'comments or the vendored FINDINGS-corrosion.md and RECON-corrosion.md, all five of '
        'which are provenance rather than teaching truth.',
        '',
        'NOTHING IN THIS COURSE GRADES A CORROSION RATE THE CORRELATION PRODUCED, a rate '
        'category, a threshold verdict, a severity region or a material choice. Digest '
        'section 21 lists every held and withdrawn item and says why each of the eighteen '
        'graded capstone fields is clear of all of them.',
        '',
        '## Exercise',
        '',
        'Not written yet.',
...
def main():
    ...
    for tier, mods in S.TIERS.items():
        ...
        manifest = {'app_slug': 'corrosion', 'tier': tier, 'content_version': 1, 'modules': []}
