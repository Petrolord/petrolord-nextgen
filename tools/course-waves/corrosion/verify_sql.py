#!/usr/bin/env python3
"""Compare the three FC9 deep seeds against the 21 bank JSONs, FIELD BY FIELD.
...
REPO = os.environ.get(
    'REPO', UP if os.path.exists(os.path.join(UP, '.git')) else '/root/wt-fc9-nextgen')
SLUG, PREFIX, DATE = 'corrosion', 'fc9', '20260925'
