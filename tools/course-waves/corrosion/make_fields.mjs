// fields.json and precision.json: the eighteen graded FC9 fields with the
...
// src/components/course/panels/corrosion/gradedTolerance.js in the NextGen
// repository, which fc9_capstone.mjs and the teaching lab both import. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/fc9_capstone.mjs`, '--json'],
