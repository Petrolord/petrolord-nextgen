...
ALLOWED = {
 ...
 '14.5038': 'the TRUNCATED bar to psia divisor the studio uses, stated in section 24 beside the engine factor it is measured against. This is the literal the section exists to expose',
 '0.3048': 'feet to metres, stated in the same conversion table',
 '0.0254': 'inches to metres, stated in the same conversion table',
 '0.45359237': 'the avoirdupois pound in kilograms, BY DEFINITION, stated in section 24 where the bar to psia factor is rebuilt from the definitions and compared against the one the engine exports',
 '9.80665': 'standard gravity in m/s2, BY DEFINITION, stated in the same rebuild',
 '100000': 'the bar in pascals, BY DEFINITION, stated in the same rebuild',
