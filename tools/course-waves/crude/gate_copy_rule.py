...
REPO = '/root/wt-md-crude-nextgen/src/content/courses/crude'
...
def main():
    ...
    if '--plant' in sys.argv:
        items.append(('planted', 'API goes through specific gravity — never averaged.\nAPI is blended through SG, not averaged.'))
