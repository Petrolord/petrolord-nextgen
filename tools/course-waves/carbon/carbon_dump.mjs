...
out('# ENGINES: engines/downstream/carbonAbatement.js and engines/downstream/energyEfficiency.js at petrolord-engines e972ae7 (MD5-0, engines PR #226, and MD45-1, engines PR #228, repaired both; engines PR #232 recast their notes), vendored in NextGen under packages/engines.');
...
section('GLOBAL WARMING POTENTIALS: A SET CARRIES ITS REPORT', ['carbonAbatement.makeGwpSet']);
{
  ...
  out('');
  out(`THE COURSE'S SET. Every inventory in this course is computed on "${G.label}", because the engine counts escaped carbon as methane (the methane note above). The other three sets are printed beside it in SECTION 8.`);
  out('');
