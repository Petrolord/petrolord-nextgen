#!/usr/bin/env bash
# =============================================================================
# B3 RECUT of the LIVE course carbon (Carbon & Energy Efficiency), content-addressed.
#
# Engines #232 (petrolord-engines e972ae7) recast engine sentences the LIVE
# carbon question bank quoted verbatim. These TEXT-ONLY migrations bring the
...
FILES="
20261015_b3_recut_carbon_beginner
20261015_b3_recut_carbon_intermediate
20261015_b3_recut_carbon_advanced
"
digest_for() {
  case $1 in
    20261015_b3_recut_carbon_beginner       ) echo 6cc32beb6ae4dbc594ef40376aadbb7eca2eb285f173ad8ea174b2e76b2adc24 ;;
    20261015_b3_recut_carbon_intermediate   ) echo 2cc91807af8b01fbee0414ee50b4c4ee00589c1fcaff37432de0fe69174a2e40 ;;
    20261015_b3_recut_carbon_advanced       ) echo 74945c0cc111e4f9885cc102345b0ea68d1010411bf97ad68071c0504d8f2de3 ;;
    *) echo UNPINNED ;;
  esac
}
