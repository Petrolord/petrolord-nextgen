...
// src/components/course/panels/forecastml/gradedTolerance.js in the NextGen
// repository, which d4_capstone.mjs imports. This
...
const rows = JSON.parse(execFileSync('node', [`${HERE}/d4_capstone.mjs`, '--json'],
