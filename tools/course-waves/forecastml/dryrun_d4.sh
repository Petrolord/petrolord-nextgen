...
#
# APPLYING IS NOT THIS SCRIPT'S JOB. The real apply is apply_d4_forecastml.sh
...
#
# Usage: dryrun_d4.sh [ref|WORKTREE] [--control <name> [field] [mult] | --idempotent]   default HEAD
# =============================================================================
set -u
REF=${1:-HEAD}
CONTROL=${2:-}
