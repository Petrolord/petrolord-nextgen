...
DATE = GC.DATE
COURSE = os.environ.get('D4_COURSE_SQL', f'{REPO}/migrations/{DATE}_d3_facies_course.sql')
OUT = os.environ.get('D4_GOLIVE_OUT', f'{REPO}/migrations/{DATE}_d3_facies_go_live.sql')
