...
# D4_WAVE_DIR and D4_ENGINES override the default paths, which is how the
# committed mirror under tools/course-waves/forecastml rebuilds it.
export TZ=UTC
export LC_ALL=C
exec node "${D4_WAVE_DIR:-/root/dai-wip-forecastml}/d4_dump.mjs"
