...
any lesson body or manifest title, and in the three D4 panels, their shared bits and the lab
...
APP_TEXT = [os.path.join(REPO, 'src/components/course/panels/forecastml', f) for f in
