#!/usr/bin/env python3
"""D4 lesson length gate (adapted from D3, D2's, itself D1's and H1's): PROSE WORDS per lesson, against that lesson's own
...
CONTENT = os.environ.get(
    'D4_CONTENT', '/root/wt-dai-d4-nextgen/src/content/courses/forecastml')
...
def selftest():
    ...
    import tempfile
    root = tempfile.mkdtemp(prefix='d4-lengths-')
