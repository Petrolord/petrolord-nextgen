#!/usr/bin/env bash
# =============================================================================
# B3 RECUT of the LIVE course refinery (Refinery Feasibility & Planning), content-addressed.
#
# Engines #232 (petrolord-engines e972ae7) recast engine sentences the LIVE
# refinery question bank quoted verbatim. These TEXT-ONLY migrations bring the
...
FILES="
20261015_b3_recut_refinery_intermediate
"
digest_for() {
  case $1 in
