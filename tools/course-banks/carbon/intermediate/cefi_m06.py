...
q(1, "Across the three invented Isiokpo steam and stream records, which call does the engine answer in part while naming the gap?",
 ...
 "The treatment-blank condensate case still prints a total and flags it as a floor (SECTION 16). The other three calls get no answer at all: SECTION 16 refuses a blank boiler efficiency, SECTION 15 a blank exponent, and SECTION 17 a blank minimum approach.")

q(0, "A blank boiler efficiency reaches both the invented Isiokpo trap and the Isiokpo condensate case. What do SECTIONS 15 and 16 print?",
...
q(3, "Which of these Isiokpo figures is an engine output, where the digest marks the other three computed here?",
 ...
 "SECTION 14's output table prints annualEnergySavedGJ 6742.370. The stack loss section marks the 8.4741 point gap computed here, SECTION 15 the 17.724 tonnes a year between exponents, and SECTION 14 the shortcut's 5923.008 GJ, which the engine does not return.")

q(1, "The invented Isiokpo trap's downstream table in SECTION 15 ends with one sentence. Which?",
 ...
 "SECTION 15 prints that sentence under the table: 42.3520 kg an hour at 1.01325, 3 and 5 bar a, all choked, then 41.4785, 37.5765 and 29.0510 at 6, 7 and 8 bar a, choked false.")

q(2, "SECTION 14 prints a saving fraction for the invented Isiokpo tuning on HHV. Which two efficiencies is it computed from?",
 ...
 "SECTION 14: on HHV the same tuning is a saving fraction of 0.0164763814, computed from the two HHV efficiencies of the stack loss section, the current 77.9288 and the target 79.2343. A pair on mixed bases is refused: \"The two efficiencies are on different bases (LHV and HHV) and cannot be compared.\"")

q(0, "Four Isiokpo figures from SECTIONS 14 to 16 are set side by side. Which of them is an amount of carbon?",
 ...
 "SECTION 16 prints annualTonnesCo2e 742.220 on the SYNTHETIC factor. 6742.370 GJ is SECTION 14's LHV energy saved, 355.757 tonnes a year is steam lost by the trap in SECTION 15, and 13230.304 GJ is SECTION 16's energySavedGJPerYear.")
...
q(2, "Pricing a saving per tonne is governed by one of the rules in force. Which wording is it?",
 ...
 "SECTION 25 lists \"The cost per tonne of a saving is the levelised abatementCost, and needs a life and a rate\" and \"A saving, its price and its factor declared on different heating value bases are refused\".")

q(0, "SECTION 17 prints the invented Isiokpo pinch at approaches of 10, 15 and 20 C. What does the pinch do across those rows?",
...
q(1, "A failed steam trap has its own rule in force. According to that row, what must a trap be given?",
 ...
 "SECTION 25: \"A trap needs a boiler efficiency for fuel and carbon, an isentropic exponent, and hours a year\", pointing at SECTION 15. The safe floor belongs to the tuning of SECTION 14 and the radiation loss to the stack loss section; 8760 hours is the stated default when hours are left out of the call.")

q(2, "Every SECTION 17 target row for the four invented Isiokpo streams prints a balance check of 0.000. How does the digest define it?",
 ...
 "SECTION 17: the balance check is (hot utility plus hot stream duty) less (cold utility plus cold stream duty): heat in less heat out, 0.000 when the targets close. Heat recovered is the hot streams' duty less the cold utility, 801.150 less 240.150 is 561.000 kW at 15 C.")
