...
q(2, "The course prints the engine's choked-flow note for the invented Isiokpo trap at an isentropic exponent of 1.3. Which critical ratio does it name?",
 "0.5457",
 ["0.5774",
  "0.1126",
  "0.555556"],
...
q(0, "5 bar a sits downstream of the invented 9 bar a trap at an exponent of 1.135. Which choked flag and hourly loss does the course pair with it?",
...
q(3, "At a downstream pressure of 8 bar a, how many tonnes of steam a year does the course print the invented Isiokpo trap losing?",
 "244.029",
 ["315.643",
  "348.419",
  "355.757"],
...
q(1, "The invented Isiokpo trap is given a downstream pressure of 9 bar a, the same as its upstream. What does steamTrapLoss answer?",
 ...
 "The course prints the 9 bar a call refused with that sentence. The required-box refusal answers a blank downstream box, the absolute-pressure refusal a downstream pressure of -1, and 29.0510 kg an hour is the 8 bar a row.")

q(2, "steamTrapLoss is called for the invented Isiokpo trap with an isentropic exponent of 1. What does the course print?",
 ...
 "The course prints the same refusal for a blank exponent and for an exponent of 1. The discharge coefficient and orifice refusals answer those boxes left blank. 42.3520 kg an hour is the loss at the stated 1.135.")
...
q(0, "The hours argument is left out of the call entirely for the invented Isiokpo trap. What does the course print?",
 ...
 "In the course, hours left out of the call take the stated default of 8760, 371.004 tonnes a year. A blank hours box and a call with 9000 hours are refused: \"Hours in service a year are required, between 0 and 8784. A blank is not read as a full year.\" 373.481 is the 1.3 exponent row at 8400 hours.")

q(1, "The course prices raising the invented Isiokpo condensate return from 0.35 to 0.65 with the treatment cost left blank. What does it print?",
 ...
 "With the treatment blank the course prints annualValue 121403.28, complete false and the valueNote \"A floor on the value: Treatment not repeated not priced. The treatment cost is the one usually left out.\" With treatment priced it prints 175835.28 and complete true.")
...
q(3, "What carbon does the invented Isiokpo condensate case report once the treatment price is left blank?",
 ...
 "The course prints annualTonnesCo2e 742.220 in both columns, on the SYNTHETIC factor of 56.1 kg CO2e per GJ. The treatment line, annualValue and complete differ between the columns. 63.721 tCO2e is the trap in the steam trap lesson.")
...
q(2, "The invented Isiokpo condensate case is called with a target return of 0.25 against the current 0.35. What does condensateReturnValue answer?",
 ...
 ["REFUSED: Return fractions must lie between 0 and 1.",
  ...
  "REFUSED: A boiler efficiency in (0, 1] is required: the fuel saved depends on it and it is not assumed."],
 "The course prints the 0.25 target refused with that sentence, and its rules in force list a target condensate return below the current one as refused. No negative annualValue is printed. A target of 1.2 draws the return-fraction refusal, and a blank boiler efficiency the boiler refusal.")

q(1, "At a minimum approach of 20 C, which utility targets does the course print for the four invented Isiokpo streams?",
...
q(0, "The course prints a threshold problem: one hot stream at 10 kW/K and one cold at 1 kW/K, at 10 C. Its heat flow is zero only at the top of the cascade. What does the engine report?",
 ...
 "The course prints hot utility 0.000, cold utility 1470.000, pinch hot none and threshold problem true. The engine reports no pinch there: a zero at either end of the cascade is a threshold, and naming it a pinch would invent a constraint. The course's rules: only an interior zero of the cascade is a pinch.")

q(3, "The course prints the engine's note on the pinch. What does it say heat carried across the pinch costs?",
...
q(1, "In the course's problem table at 15 C for the invented Isiokpo streams, where does the heat flow reach zero, and how is the pinch reported?",
 ...
 "In the course, the heat flow is zero at shifted 110.500 C, inside the range: the pinch, 118.000 C on the hot side and 103.000 C on the cold side. The cascade starts at 155.500 with the hot utility 25.950 and ends at 33.500 with the cold utility 240.150. 108.000 C is the cold side pinch at 10 C.")
