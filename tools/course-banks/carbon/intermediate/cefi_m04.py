...
q(1, "SECTION 14 prints the engine's method for the saving from tuning the invented Isiokpo heater. Which ratio does it give?",
...
q(3, "The digest works the percentage-point shortcut on the invented Isiokpo figures, 410000 GJ a year on LHV. What does it print for it?",
 ...
 "SECTION 14, computed here from the engine's efficiencies: a saving fraction of 0.0144463600, which is 5923.008 GJ a year, 819.363 GJ below the engine's saving. The engine's own sentence says subtracting the percentages understates the saving. 6742.370 is annualEnergySavedGJ and 8337.934 the 2.0 row of the sweep.")

q(0, "Which figure in SECTION 14 is the saving fraction of the percentage-point shortcut, the digest's own arithmetic on the invented Isiokpo efficiencies?",
 "0.0144463600",
 ["0.0164448058",
  "0.0164763814",
  "6742.370"],
 "SECTION 14 prints the shortcut's fraction as 0.0144463600 and marks it computed here; the engine does not return it. 0.0164448058 is the engine's fuelSavingFraction on LHV, 0.0164763814 the HHV fraction from the two HHV efficiencies of the stack loss section, and 6742.370 is annualEnergySavedGJ.")

q(2, "The invented Isiokpo tuning is asked for a target of 1.5 percent oxygen against the 2 percent floor declared after a combustion test. What does SECTION 14 print?",
...
q(3, "excessAirSaving is given a current efficiency on LHV and a target efficiency on HHV for the invented Isiokpo heater. What does SECTION 14 print?",
 "REFUSED: The two efficiencies are on different bases (LHV and HHV) and cannot be compared.",
 ["No refusal: the engine converts the HHV target to LHV and prints fuelSavingPercent 1.6445.",
  ...
  "REFUSED: The target stack oxygen is required, so that it can be checked against the declared safe floor."],
 "SECTION 14 prints the mixed pair refused with that sentence. 1.6445 is the LHV fuelSavingPercent from two LHV efficiencies and 1.6476 the HHV figure from two HHV efficiencies. The target-required refusal answers a blank target.")
...
q(1, "How does excessAirSaving arrive at annualEnergySavedGJ 6742.370 for the invented Isiokpo heater?",
 ...
 "SECTION 14 prints the fraction, 0.0164448058, and the fuel it is applied to, 410000 GJ a year on LHV (invented); annualEnergySavedGJ is 6742.370. The digest's shortcut applies 0.0144463600 to the same fuel and gets 5923.008 GJ.")

q(3, "SECTION 14 prints a saving fraction of 0.0164763814 for the same invented tuning on HHV. What does it say about the fuel figure that fraction multiplies?",
 ...
 "SECTION 14: \"The engine multiplies a saving fraction by the annual fuel it is given, and the basis of that fuel figure is the caller's to match.\" It prints no annual HHV saving in gigajoules, and the 410000 GJ it prints is stated on LHV.")
...
q(2, "What fuelSavingPercent does SECTION 14 print for the same invented tuning, 5.5 to 2.8 percent oxygen, on HHV?",
 "1.6476",
 ["1.6445",
  "2.0336",
  "1.2718"],
...
q(0, "What basis does the SECTION 14 output carry for the invented Isiokpo tuning, and on what basis is its 410000 GJ of fuel a year stated?",
 ...
 "SECTION 14's output table prints basis LHV, and its inputs are 410000 GJ of fuel a year on LHV (invented). The two efficiencies it takes, 86.4029 and 87.8476, are the LHV rows of the stack loss section.")
