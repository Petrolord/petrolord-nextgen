...
q(3, "Rebuilt on IPCC AR6 GWP100, non-fossil methane, what does the vented and fugitive methane line read?",
 ...
 ["4231.600 tCO2e",
  "4260.000 tCO2e",
  "3976.000 tCO2e"],
 "The lab prints the vented line at 4231.600 on IPCC AR6 GWP100, fossil methane, 3834.000 on AR6 non-fossil, 4260.000 on AR5 fossil and 3976.000 on AR5 non-fossil. Only the methane lines move from set to set.")
...
q(1, "The flare's unburned methane line reads 489.183 tCO2e. On which set was it converted?",
 ...
 "The lab prints Flaring (unburned CH4) at 485.922 on AR6 fossil, 440.265 on AR6 non-fossil, 489.183 on AR5 fossil and 456.571 on AR5 non-fossil.")

q(0, "Which total does the lab print for the inventory on IPCC AR5 GWP100, non-fossil methane?",
 "42660.826 tCO2e",
 ["42945.777 tCO2e",
  "42502.520 tCO2e",
  "42977.438 tCO2e"],
 "The lab prints the totals: 42945.777 on AR6 fossil, 42502.520 on AR6 non-fossil, 42977.438 on AR5 fossil and 42660.826 on AR5 non-fossil. Scope 2 is 12915.000 under all four.")
...
q(2, "When the Igbogene inventory is rebuilt on another GWP set, which lines move?",
 ...
 "The lab: \"Only the methane lines move; every CO2 line has a GWP of 1 on every set.\" Scope 2 reads 12915.000 on all four sets, and the vented line moves with the set as the flare's methane line does.")
...
q(1, "Which two methane values does AR6 give in the sets the course prints?",
 ...
 "The course prints AR6 fossil CH4 29.8 and AR6 non-fossil CH4 27; AR5 gives 30 and 28. 273 is the AR6 value for N2O.")
...
q(3, "What N2O value do both AR5 sets carry?",
 ...
 ["273",
  "28",
  "30"],
 "The course prints N2O 265 on both AR5 sets and 273 on both AR6 sets. 28 and 30 are the AR5 methane values, non-fossil and fossil.")
...
q(0, "Which makeGwpSet call returns a set the engine reads as declared?",
 ...
 "The engine: a set is declared only with a label and at least one value. Values with no label, and a label with no values, both read declared false. The engine refuses a methane GWP of 0, and the set then reads declared false.")
...
q(2, "The engine's note on every GWP set says the set is stated on every result. What reason does the note give?",
 ...
 "The course quotes the note: \"Global warming potentials differ between IPCC assessment reports. An inventory on one report is not comparable with one on another, so the set is stated on every result.\" Every CO2 line has a GWP of 1 on every set, and which report to file on is held (H1).")
...
q(1, "For which methane does the engine's methane note call the fossil value the consistent one?",
 ...
 "The course quotes the methane note on every set. It closes: \"the fossil value is the consistent one for vented, fugitive and unburned fossil methane alike.\"")

q(3, "Measured from the course set, what does the lab print for the AR6 non-fossil total?",
 "-443.257 tCO2e",
 ["-284.951 tCO2e",
  "31.661 tCO2e",
  "0.000 tCO2e"],
 "The lab prints the total less the course set as 0.000 on AR6 fossil, -443.257 on AR6 non-fossil, 31.661 on AR5 fossil and -284.951 on AR5 non-fossil (computed here).")
...
q(0, "What does the course state about which IPCC report a Nigerian operator should file on?",
 ...
 ["AR6, since every inventory in the course is computed on IPCC AR6 GWP100, fossil methane, as a rule.",
  "AR5, since the course states that UNFCCC reporting has required it of operators until now.",
  "Whichever report gives the lower Igbogene total, which the course prints for all four of the sets."],
...
q(2, "The four sets the course types in are tabulated in which document?",
 ...
 "The course: the four sets are IPCC 100-year values as tabulated in GHG Protocol, \"IPCC Global Warming Potential Values\", version 2.0, 7 August 2024, adapted from IPCC AR6 WG1 chapter 7 and IPCC AR5 WG1 chapter 8. The engine ships no GWP.")
...
q(1, "Why does the course compute every inventory on IPCC AR6 GWP100, fossil methane?",
 ...
 ["AR6 is the report an operator must file on, as the course recommends.",
  ...
  "It gives the lowest Igbogene total of the four sets the course prints."],
 "The course: \"Every inventory in this course is computed on 'IPCC AR6 GWP100, fossil methane', because the engine counts escaped carbon as methane\" (the methane note). With no set declared, the engine blocks the vented line, and the lab prints a lower total, 42502.520, on AR6 non-fossil.")
...
q(3, "Where does the engine record which GWP set an inventory was converted on?",
 ...
 "The course: \"The engine states its set on every result (gwpSetLabel), and an intensity carries it too.\" The lab prints gwpSetLabel: IPCC AR6 GWP100, fossil methane on the complete inventory, and the factor records name sources such as the supplier statement (invented).")
...
q(2, "What horizon do all four of the course's GWP sets share?",
 ...
 "The lab prints the horizon column as 100-year (GWP100) on all four sets, AR6 and AR5, fossil and non-fossil.")
