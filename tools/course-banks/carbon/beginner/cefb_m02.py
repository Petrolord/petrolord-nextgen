...
q(3, "One thousand kilomoles of a fuel with one carbon atom a molecule are burned at a destruction efficiency of 0.98. What does the engine return?",
 ...
 "SECTION 3 prints the 0.98 row as carbon kmol 1000.000, co2Tonnes 43.129, ch4Tonnes 0.321. The other pairs are the rows for 0.99, 0.95 and complete combustion at 1.")
...
q(0, "In the 1000 kmol table, what does the carbon kmol column do as the destruction efficiency falls from 1 to 0.95?",
 ...
 "SECTION 3 prints carbon kmol 1000.000 on all four rows. The destruction efficiency divides that carbon between CO2 and methane: co2Tonnes falls from 44.009 to 41.809 and ch4Tonnes rises from 0.000 to 0.802.")
...
q(2, "Each kilomole of carbon that escapes combustion leaves as how many kilograms of methane?",
 ...
 "SECTION 3: \"Each kilomole that escapes leaves as MW_CH4 kilograms of methane.\" SECTION 1 prints carbonAbatement.MW_CH4: 16.043. MW_CO2 weighs the carbon that burns, and 30.070 is ethane's row in FUEL_REFERENCE.")
...
q(3, "The same Igbogene heaters are run with a lower destruction efficiency typed, 0.995. What does the engine return?",
 ...
 "SECTION 4 prints the 0.995 row as 23005.841 t of CO2 and 42.143 t of methane. The 0.999 row is 23098.327 and 8.429, and at the typed 1 the heaters return 23121.448 and 0.000. 22272.955 is the heaters' co2Tonnes in the row for a carbon per kmol of 1.05.")
...
q(2, "The heaters' fuel stays at 482000 kmol a year and the carbon per kilomole of fuel is typed as 1.05. What is co2Tonnes?",
 ...
 ["21212.338",
  "23121.448",
  "24394.189"],
 "SECTION 4 prints the carbon per kmol table: 1.00 gives 21212.338, 1.05 gives 22272.955, the Igbogene 1.09 gives 23121.448 and 1.15 gives 24394.189 t of CO2.")

q(0, "How does the digest describe the Igbogene heaters' carbon per kilomole of fuel, 1.09?",
 ...
 "SECTION 4: \"The carbon per kilomole of fuel is the fuel analysis read as carbon atoms: the Igbogene figure is an input.\" SECTION 2 refuses a call with the carbon per kmol left out, so there is no default, and the supplier statement is the source of the electricity factor in SECTION 7.")
...
q(1, "Which two flare calls get the same refusal, \"The destruction efficiency must lie in (0, 1].\"?",
 ...
 "SECTION 2 prints the interval refusal for 0 and for 98 typed as a percentage. A blank is refused as required, a fuel of -1 kmol is refused as negative, and 1 lies inside (0, 1], so it computes: SECTION 3 prints a row at 1.")
...
q(0, "Fuel typed as -1 kmol on the flare: which refusal follows?",
 ...
 "SECTION 2 prints the negative refusal for a fuel of -1 kmol. The \"are required\" refusal is for a blank fuel or a carbon per kmol left out, the interval refusal is for the efficiency, and the factor refusal belongs to emissionLine.")
...
q(1, "carbonAbatement.MW_CO2 reads 44.009. How does the digest say it is built?",
 ...
 "SECTION 3: MW_CO2 44.009 is 12.011 plus two oxygens at 15.999, and MW_CH4 16.043 is 12.011 plus four hydrogens at 1.008. MW_C, 12.011, is the carbon atom alone.")

q(2, "The Igbogene heaters' destruction efficiency is 1. How does SECTION 4 record it?",
 ...
 "SECTION 4 lists the inputs as \"destruction efficiency 1 (complete combustion, typed)\". The stated default applies only to an argument left out of the call (SECTION 2), and the flare study states the flare's 0.98.")
