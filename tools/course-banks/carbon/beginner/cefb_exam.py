...
q(2, "The digest separates a blank box from an argument left out of the call. How does each reach the engine?",
...
q(0, "Which module does the Carbon Footprint & Abatement Studio call?",
 ...
 "SECTION 1 pairs each studio with one module: the Carbon Footprint & Abatement Studio with carbonAbatement, the Efficiency Studio with energyEfficiency.")
...
q(3, "Which label does the Scope 2 total carry in buildInventory's output?",
 ...
 "The SECTION 7 totals table reads Scope 1 (direct), Scope 2 (purchased energy) and Total, Scope 1 and Scope 2.")
...
q(1, "Refusing an intensity with no boundary, the engine names two figures that differ for one plant. Which two?",
 ...
 "The carbonIntensity refusal in SECTION 2 names tonnes per tonne charged and tonnes per tonne of saleable product. The Igbogene boundaries are per barrel, and they are inputs to the call.")
...
q(1, "Which factor unit does the Purchased electricity line carry?",
 ...
 ["tCO2/tCO2",
  "tCH4/t",
  "tCH4/tCH4"],
 "SECTION 7 prints the factor unit tCO2/MWh on Purchased electricity, beside Igbogene's invented factor of 0.41. tCO2/tCO2 and tCH4/tCH4 belong to the atom-balance lines and tCH4/t to the vented line.")
...
q(3, "Typing 98 as the flare's efficiency, meant as a percentage, produces what?",
 ...
 "SECTION 2 prints this refusal for 98 typed as a percentage, the same sentence it prints for 0. The flare's stated efficiency is typed as the fraction 0.98.")
...
q(0, "Which pair does the 1000 kmol table print at 0.99?",
 ...
 "Row 0.99 of the SECTION 3 table: co2Tonnes 43.569, ch4Tonnes 0.160. 44.009 belongs to complete combustion, and 0.321 and 0.802 are the methane at 0.98 and 0.95.")
...
q(2, "Typed at 1.15 kmol of carbon per kmol, with the fuel unchanged, what do the Igbogene heaters emit?",
 ...
 ["23121.448 t",
  "21212.338 t",
  "25799.177 t"],
 "The carbon per kmol table in SECTION 4 gives 24394.189 at 1.15. 25799.177 is not a heater figure; it is an inventory total with two blocked lines.")
...
q(3, "Which pair is the Igbogene heaters' 0.999 row?",
 ...
 "SECTION 4's lower-efficiency table: 0.999 gives 23098.327 and 8.429; 0.995 gives 23005.841 and 42.143.")
...
q(1, "Which carbonAbatement constant reads 12.011?",
 ...
 "The constants block of SECTION 1 lists MW_C as 12.011, beside MW_CO2 44.009 and MW_CH4 16.043.")
...
q(2, "Which figure is the Igbogene flare's CO2 when it burns at 0.9?",
 ...
 ["2124.711",
  "2236.537",
  "2191.807"],
 "The flare row at 0.9 in SECTION 5 reads co2Tonnes 2012.884, beside 81.531 t of methane.")
...
q(3, "Which row of the flare table totals 2457.133 tCO2e?",
 ...
 "In SECTION 5 the 0.99 row prints a flare total of 2457.133 and ch4Tonnes 8.153. Rows 0.98, 0.95 and 0.9 total 2677.729, 3339.515 and 4442.493.")
...
q(1, "Read the 0.95 row of the Igbogene flare table. What is ch4Tonnes?",
 ...
 "SECTION 5, row 0.95: ch4Tonnes 40.765. Its methane line, 1214.805, is in tCO2e and is a different quantity.")
...
q(2, "The escaped-carbon note ends with an instruction for a user holding a measurement. What is it?",
 ...
 "The last sentence of the escaped-carbon note in SECTION 5 is \"Override it if you have measured otherwise.\"")
...
q(0, "A source is kept outside the boundary on purpose, excluded true. How many lines does atomBalanceLines hand the inventory?",
 ...
 ["1 blocked line",
  "2 lines at 0.000 t",
  "1 unsourced line"],
 "SECTION 9 prints 0 lines for excluded true. A refused flare, by contrast, arrives as one blocked line labelled Flaring.")
...
q(3, "On the AR5 non-fossil set, the flare's escaped carbon becomes a line of how many tCO2e?",
 ...
 ["440.265 tCO2e",
  "489.183 tCO2e",
  "485.922 tCO2e"],
 "456.571 is the AR5 non-fossil entry in the SECTION 8 methane table; 440.265 and 489.183 are AR6 non-fossil and AR5 fossil.")

q(1, "How far above or below the course set does the digest place the Igbogene total on AR5 fossil methane?",
 "31.661 tCO2e",
 ["-443.257 tCO2e",
  "-284.951 tCO2e",
  "0.000 tCO2e"],
 "SECTION 8 reads 42977.438 for AR5 fossil, and its computed-here column puts that 31.661 above the course set's 42945.777.")
...
q(0, "What N2O value sits in the course's own set?",
 ...
 ["265",
  "29.8",
  "27"],
 "The course's set is CH4 29.8 and N2O 273 (SECTION 6). The AR5 sets carry 265.")
...
q(3, "makeGwpSet is given a label and no values. What does the set read?",
 ...
 "The SECTION 6 declared table reads false for a label with no values and false for values with no label.")
...
q(1, "The flare efficiency is entered with the GWP set already declared. What reasons for not being reportable does buildInventory then give?",
 ...
 "That is the \"flare efficiency entered\" row of SECTION 9: 5 lines, Scope 1 30030.777, and the electricity factor still blank.")
...
q(0, "At which step does the Igbogene Scope 2 total first read 12915.000 tCO2e?",
 ...
 ["The GWP set declared",
  ...
  "The first pass"],
 "SECTION 9 gives Scope 2 as 0.000 on the first three rows; the electricity factor entered with its source brings in the 12915.000.")
...
q(2, "Across the five Igbogene steps, what does the computed flag read?",
 ...
 "Every row of the SECTION 9 step table reads computed true. The reportable flag is the one that turns, on the last row.")
...
q(3, "The vented activity is typed as -142 t and the electricity factor as -0.41. What does that inventory return?",
 ...
 "SECTION 9 blocks both negative lines and prints the inventory at 25799.177, reportable false, with 2 line(s) that could not be computed.")
...
q(1, "Which Scope 2 intensity does the inlet to export boundary carry?",
 ...
 ["0.00822761",
  "0.00535892",
  "0.01176597"],
 "SECTION 10's inlet to export row: Scope 1 0.00822761, Scope 2 0.00353836, total 0.01176597. 0.00535892 is the crude export only Scope 2.")
...
q(0, "Which denominator and unit sit under the boundary \"Igbogene crude export only\"?",
 ...
 "The two boundary rows of SECTION 10 carry 3650000 in barrels of oil equivalent produced and 2410000 in barrels of oil exported, both invented.")
...
q(3, "The inventory disclaimer warns against keeping a second copy of obligations in the inventory. What would the copy create?",
 ...
 "The disclaimer in SECTION 7 ends: keeping a second copy of them here would create two records that could disagree.")
...
q(2, "Which share of the complete total belongs to the vented and fugitive methane?",
 ...
 ["0.300728",
  "0.538387",
  "0.011315"],
 "From the SECTION 7 share table (computed here): 0.098534 for vented methane, 0.300728 for electricity, 0.538387 for the heaters.")
...
q(2, "How many lines does the Igbogene first pass build, and how many of them are blocked?",
 ...
 "SECTION 9 counts the first pass at 4 lines, with 3 blocked and 0 unsourced.")
...
q(1, "21212.338 t of CO2 is the heaters' figure at which carbon per kilomole of fuel?",
 ...
 ["1.05",
  "1.09",
  "1.15"],
 "In SECTION 4, 1.00 is the row at 21212.338; 1.09 is the Igbogene input.")
...
q(0, "Which co2Tonnes figure belongs to the flare's 0.99 row?",
 ...
 ["2191.807",
  "2236.537",
  "2457.133"],
 "Flare row 0.99 in SECTION 5 reads co2Tonnes 2214.172; 2457.133 on that row is the total in tCO2e.")
...
q(3, "How does the engine's note describe counting escaped carbon as methane?",
 ...
 "The SECTION 5 note calls it \"the usual and conservative assumption\" and says to override it if you have measured otherwise. H3 holds it as the engine's stated assumption.")
...
q(2, "Typed at 0.95 in place of the stated 0.98, where does the flare's unburned methane line go?",
 ...
 "From the 0.98 row to the 0.95 row of SECTION 5 the methane line goes from 485.922 to 1214.805 tCO2e. 16.306 and 40.765 are tonnes of methane.")
...
q(1, "Switched from the AR6 fossil set to the AR6 non-fossil set, where does the flare's unburned methane line go?",
 ...
 "SECTION 8 lists the flare's methane line as 485.922 on AR6 fossil and 440.265 on AR6 non-fossil; the AR5 figures are 489.183 and 456.571.")
...
q(3, "Which Igbogene figure holds still across all four GWP sets?",
 ...
 "Scope 2 is a CO2 line with a GWP of 1 whatever the set, so SECTION 8 prints 12915.000 four times.")
...
q(0, "Which flare tCO2e sits on the stated 0.98 row?",
 ...
 ["2236.537 tCO2e",
  "2191.807 tCO2e",
  "3339.515 tCO2e"],
 "The SECTION 5 row at 0.98 prints a flare total of 2677.729, of which 2191.807 is CO2.")
...
q(1, "Which boundary's intensity is stated in tCO2e per barrel of oil equivalent produced?",
 ...
 "SECTION 10 gives the inlet to export boundary in barrels of oil equivalent produced and crude export only in barrels of oil exported.")
