...
q(0, "What source and version does the Igbogene purchased electricity factor carry in the complete inventory?",
 ...
 "SECTION 7 prints the Purchased electricity line with factor 0.41 tCO2/MWh (invented and SYNTHETIC), source \"Supplier statement (invented)\", version 2025 and provenance complete true. The survey is the vented methane's source, the atom balance the combustion lines', and the complete inventory has 0 unsourced lines.")
...
q(2, "Why is the Igbogene first pass not reportable, as buildInventory states it?",
 ...
 "SECTION 9 prints the first pass reason as \"the global warming potential set is not declared; 3 line(s) could not be computed\". The other three are the reasons at the next three steps: the GWP set declared, the flare efficiency entered, and the electricity factor entered with its source.")
...
q(3, "Which step of the Igbogene inventory is the first that buildInventory reads as reportable?",
 ...
 "SECTION 9 prints reportable false on the first four steps and true only on \"the survey referenced\", whose reason reads none. The step before it totals the same 42945.777 tCO2e and is not reportable because 1 factor(s) have no source or version.")

q(1, "In the first pass the vented methane survey is not referenced, yet the unsourced line count reads 0. What does the digest say?",
 ...
 "SECTION 9: \"The first pass has 3 blocked line(s) and 0 unsourced line(s); a blocked line is not also counted as unsourced.\" The vented line is blocked there for want of a GWP for CH4. At the next step the reason \"1 factor(s) have no source or version\" appears while reportable is still false.")
...
q(0, "In the first pass, what does the engine name as blocking the Vented and fugitive methane line?",
 ...
 "SECTION 9 lists the first pass blocked lines: Flaring blocked by the destruction efficiency refusal, Vented and fugitive methane by \"no global warming potential for CH4 in the declared set\" and Purchased electricity by \"no factor value\". The other two reasons belong to the Diesel generators line and to the vented activity typed as -142 t.")
...
q(2, "At the step \"the GWP set declared\", what does the Igbogene Scope 1 total read?",
 ...
 ["23121.448 tCO2e",
  "30030.777 tCO2e",
  "25799.177 tCO2e"],
 "SECTION 9 prints Scope 1 at 23121.448 in the first pass, 27353.048 once the GWP set is declared and 30030.777 once the flare efficiency is entered. 25799.177 is the total of the inventory with a negative activity and a negative factor.")
...
q(3, "The vented methane activity is typed as -142 t. What does buildInventory do with that line?",
 ...
 "SECTION 9 prints the line \"Vented methane typed as -142 t\" with tCO2e none, blocked by \"a negative activity: an emission line cannot remove tonnes\". That inventory totals 25799.177 tCO2e and is not reportable.")
...
q(1, "A Diesel generators line with no registered factor is added to the complete inventory. What reason does its blocked line carry?",
 ...
 ["no factor value, so it is read as zero",
  ...
  "1 factor(s) have no source or version"],
 "SECTION 9 prints the Diesel generators line with the reason \"A registered emission factor is required.\" The scope 3 reason belongs to Business travel. With both lines added the total stays 42945.777 tCO2e and the inventory is not reportable because 2 line(s) could not be computed.")

q(0, "The digest's line shares of the Igbogene total, as printed, sum to 1.000001. What does its rounding note say?",
 ...
 "SECTION 7: \"ROUNDING NOTE: the shares as printed sum to 1.000001; each is rounded to six decimals from the unrounded quotient, and the unrounded shares sum to 1.\" The complete inventory has 0 blocked lines.")
...
q(3, "Over the boundary \"Igbogene crude export only\", what total intensity does carbonIntensity return?",
 ...
 "SECTION 10 prints crude export only, denominator 2410000, Scope 1 intensity 0.01246090, Scope 2 intensity 0.00535892 and total intensity 0.01781982. 0.01176597 is the total over the inlet to export boundary, per barrel of oil equivalent produced.")
...
q(2, "What two conditions does the engine's comparability note on an intensity set?",
 ...
 "SECTION 10 quotes the note: \"Comparable only with an intensity on the same boundary (Igbogene flow station and gas plant, inlet to export) and the same global warming potential set (IPCC AR6 GWP100, fossil methane).\"")
...
q(1, "With the electricity factor blank, what does the total intensity over the inlet to export boundary read?",
 ...
 "SECTION 10: with the electricity factor blank the total intensity is 0.00822761 tCO2e per barrel of oil equivalent produced, reportable false, because 1 line(s) could not be computed. An intensity inherits its inventory's status. 0.01176597 is the complete inventory's total intensity.")
...
q(0, "In the first pass, Scope 2 reads 0.000 tCO2e. What does the digest show behind that figure?",
 ...
 "SECTION 9 lists Purchased electricity among the first pass blocked lines, \"blocked: no factor value\". Once the factor is entered with its source, Scope 2 reads 12915.000. SECTION 7 prints the line on scope 2 with an activity of 31500.000 MWh.")
