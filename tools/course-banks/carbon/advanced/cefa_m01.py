...
q(2, "For the invented Heat integration project, which figure does SECTION 18 mark computed here and print only as the wrong route?",
 "688.2353 USD a tonne, the whole capital set against one year",
 ["-14.2492 USD a tonne, the engine's cost per tonne at a rate of 0.1",
  "-66.6667 USD a tonne, the engine's cost per tonne at a rate of 0",
  "-120.5882 USD a tonne, the cost with a capital of 0 typed"],
 "SECTION 18 labels only the capital-against-one-year column computed here, from the inputs, and says the engine refuses to compare a one-off cost with a recurring saving. -14.2492 and -66.6667 USD are the engine's costs at 0.1 and at 0, and -120.5882 USD is the engine's answer with capital 0 typed (SECTION 19).")
