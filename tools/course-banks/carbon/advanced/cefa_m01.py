...
q(2, "On the invented AGBOR records, the capital box of one measure is left empty (the Heat integration project). What is the engine's answer?",
 ...
 "The engine returns, for the capital cost blank: REFUSED: Measure \"Heat integration project\" has no capital cost. Enter 0 if it needs none: a blank is not read as free. The life and rate refusals belong to other blanks, and assumedZero names only the running figures.")
...
q(0, "The invented Heat integration project is sent with its annual savings and its annual cost both left blank. What does abatementCost return?",
 ...
 "In the course, blank running figures are taken as 0 and NAMED; with the savings and the running cost blank the measure answers costPerTonne 106.3391 USD, assumedZero: annual savings, annual cost. -14.2492 USD is the measure as costed in the cost table, and -120.5882 USD is the call with capital 0 typed.")
...
q(3, "A user types the discount rate as 10, meaning ten percent, on a measure with capital. What does abatementCost do?",
 ...
 "Discount rate 10 (a percentage typed), and the engine returns REFUSED: The discount rate is a fraction greater than -1 and below 1 (0.1 for ten percent). The blank-rate refusal is a different call, and -14.2492 USD a tonne is the measure costed at a rate of 0.1.")
...
q(1, "The invented Heat integration project is sent with a capital of 0 typed, and no life and no rate. What comes back?",
 ...
 "In the course, a capital of 0 typed needs no life and no rate: Heat integration project with capital 0 answers costPerTonne -120.5882 USD and capitalRecoveryFactor 0.00000000. 106.3391 USD is the call with the savings and the running cost blank.")
...
q(1, "A measure is sent with an abatement of 0 tonnes a year. What does abatementCost return?",
 ...
 "In the course, an abatement of 0 is accepted and has no cost per tonne: costPerTonne none, paysForItself false. The annual abatement refusal is the call with the abatement blank, and the negative abatement refusal is the call with -500 t a year.")
...
q(3, "The invented Agbor measures are costed at a rate of 0 (straight line) as well as at 0.1. Which measure's cost per tonne carries a minus sign at one rate and none at the other?",
 ...
 "The cost table prints Solar for purchased power at 45.8573 USD a tonne at 0.1 and -13.5714 USD a tonne at a rate of 0. The other three rows keep one sign at both rates: Flare gas recovery and Vapour recovery stay positive, and the Heat integration project stays negative.")
...
q(0, "The invented Heat integration project and Flare gas recovery both print a capital recovery factor of 0.13147378. What do the two rows share that the factor is built from?",
 ...
 "The course prints the factor as r(1 + r)^n / ((1 + r)^n - 1): the rate and the life. Both rows carry a life of 15 years at 0.1. Their capital costs are 2750000 and 4900000 USD, they act on heaters and flare, and Flare gas recovery carries an annual cost of 105000 USD.")

q(2, "For the invented Heat integration project, which figure sits in the cost table column whose header is marked computed here?",
 ...
 "Of the two columns in the course's second cost table, only the header of the capital-against-one-year column carries (computed here), and the sentence above it says the engine refuses to compare a one-off cost with a recurring saving. -14.2492 USD is the cost per tonne at 0.1, -66.6667 USD the cost per tonne at a rate of 0, and -120.5882 USD the answer with capital 0 typed.")
...
q(3, "A capital measure arrives with its life box empty. Apart from asking for the life, which sentence does the refusal carry?",
 ...
 "The life-blank refusal, second sentence: \"Set against one year's saving, a one-off capital cost overstates the cost per tonne of a capital measure.\" The engine refuses the call; it never reads a blank life as one year.")
...
q(1, "The six invented Agbor measures are handed to the curve with the Heat integration project's capital cost blank. What does the curve return?",
 ...
 "The engine returns 5 steps, totalAbatementTonnes 12060.000, and refusedMeasures lists Heat integration project with its capital refusal. The refusedNote: \"A refused measure is off the curve and out of every total until it is costed.\" 15460.000 is the curve with all six costed.")

q(0, "The invented Tune the fired heaters prints a net annual cost of -127251.65 USD. How does the course define the net annual cost?",
 ...
 "In the course, the net annual cost is the annualised capital plus the annual cost less the annual savings; the cost per tonne is that over the tonnes abated a year. For Tune the fired heaters that is 4748.35 USD of annualised capital, an annual cost of 0 and savings of 132000 USD.")
...
q(2, "Costed at the invented discount rate of 0.1, which of these Agbor measures reads pays for itself true?",
 ...
 ["Vapour recovery on the storage tanks",
  ...
  "Flare gas recovery"],
 "The cost table prints the Heat integration project at -14.2492 USD a tonne, pays for itself true: a negative cost per tonne means the measure pays for itself and abates carbon as a side effect. Vapour recovery (35.4193), Solar (45.8573) and Flare gas recovery (78.1002) read false.")
...
q(2, "A measure with capital is sent with its discount rate blank. What does the refusal say reading that blank as 0 would do?",
 ...
 "The rate-blank refusal: \"A blank is not read as 0, which would annualise straight-line and move the measure down the curve.\" Overstating is the wording of the life blank, and free is the wording of the capital blank.")
...
q(3, "Which pair of invented Agbor measures prints a minus sign both at the rate of 0.1 and in the capital-against-one-year column?",
 ...
 "In the cost table, Tune the fired heaters prints -167.4364 and -150.0000 USD a tonne, and Repair failed steam traps -156.4390 and -133.0435. The Heat integration project prints 688.2353 against one year, Solar 45.8573 at 0.1 and Vapour recovery 35.4193 at 0.1.")

q(0, "The invented Flare gas recovery prints a net annual cost of 484221.51 USD. Which three printed figures does the course's definition build it from?",
