...
# carbon Expert m03, Interactions and over-claims. Digest SECTION 21 (the
# invented AGBOR inventory on IPCC AR6 GWP100, fossil methane; the emissions
# passed to the curve; the four curves and their verdicts; uncheckedClaims and
# uncheckedSources) and SECTION 20's interaction note. Every figure is invented
# for this course; money is in US dollars. 15 questions.

q(2, "On the invented AGBOR inventory (IPCC AR6 GWP100, fossil methane), which emission does the Carbon Studio pass to the curve for the flare?",
 "7562.133 tCO2e, its CO2 plus its methane in CO2e",
