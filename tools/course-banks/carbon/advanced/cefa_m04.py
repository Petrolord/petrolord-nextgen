...
q(1, "On the invented AGBOR path, which year is firstShortfallYear, and what gap does the path print in it?",
 ...
 "SECTION 22: firstShortfallYear: 2027, and the 2027 row prints an unabated gap of 494.298 t. 2028 prints 798.595 t, 2033 prints 1370.083 t, and 2029 prints 0.000.")
...
q(2, "The Agbor electricity factor is left blank and the path is built on that inventory. What does it print for finalGapTonnes?",
 ...
 "SECTION 22, ON A PARTIAL INVENTORY: with the electricity factor blank the inventory totals 45112.276 tCO2e and is reportable false; the path on it prints finalGapTonnes 0.000. 1370.083 t is the full inventory's final gap and 3220.083 t the path with a measure unscheduled.")
...
q(0, "Built on the partial Agbor inventory instead of the full one, which path figure moves from 39270.193 t to 31578.593 t?",
 ...
 "SECTION 22 prints the target in the end year as 39270.193 t on the full inventory and 31578.593 t on the partial one. finalGapTonnes moves from 1370.083 to 0.000, and the measures are the same six.")
...
q(3, "In 2029 the Agbor path prints emissions of 48690.276 t against a target of 48887.383 t. What does the unabated gap column print?",
 ...
 "SECTION 22: in every row the unabated gap is emissions less the target where that is positive, else 0.000. The 2029 row prints 0.000. Each row is read on its own emissions and target: 494.298 t is the 2027 row and 798.595 t the 2028 row, and 815.785 t is the 2032 row of the unscheduled path.")
...
q(1, "Vapour recovery on the storage tanks is given no start year. What does the path do with it?",
 ...
 "SECTION 22: a measure with no start year is named and left off the path: unscheduledMeasures Vapour recovery on the storage tanks (no start year); finalGapTonnes 3220.083. SECTION 25 lists the rule: a measure with no start year is named.")

q(0, "The digest prints the unscheduled path's final gap less the scheduled one as 1850.000 t. Which figure does SECTION 22 say that matches?",
 ...
 "SECTION 22: that gap less the scheduled plan's 1370.083 is 1850.000 t (computed here), the vapour recovery measure's tonnes a year. The unscheduled 2032 gap is 815.785 t, the full baseline less the partial is 10988.000 tCO2e, and Repair failed steam traps abates 1150.000 t.")
...
q(2, "The same six Agbor measures are run against an invented baseline of 12000 t. What comes back?",
 ...
 "SECTION 22: REFUSED: In 2030 the scheduled measures abate 13610 t against a baseline of 12000 t. Emissions cannot fall below zero, so check the measures for double counting or a source outside the baseline. overAbatedYear 2030.")
...
q(1, "Which invented Agbor measure is the last to go live on the path?",
 ...
 "SECTION 22's start years run from 2027 to 2031, and Vapour recovery on the storage tanks carries 2031; its row joins the measures live from 2031. Flare gas recovery starts in 2030, Solar for purchased power in 2028 and the Heat integration project in 2029.")
...
q(2, "How does the Carbon Studio draw the target on the Agbor path?",
 ...
 "SECTION 22: the target falls in a straight line from the baseline in 2026 to 30 percent below it in 2033, as the Carbon Studio draws it: 56100.276 t in 2026 and 39270.193 t in 2033. 16830.083 tCO2e is the curve's target of SECTION 21, and each measure counts in full from its start year.")
...
q(3, "From 2031 to 2033 the Agbor target falls from 44078.788 to 39270.193 t. Which column holds one value across those years?",
 ...
 "SECTION 22 prints emissions of 40640.276 t and abated tonnes of 15460.000 t in 2031, 2032 and 2033. The gap prints 0.000 in 2031 and 2032 and 1370.083 t in 2033, and 13610.000 t is the abated column of the unscheduled path.")
...
q(0, "One path summary figure agrees between the partial inventory and the full one. Which?",
 ...
 "SECTION 22 prints firstShortfallYear 2027 on both baselines. On the partial inventory the end-year target is 31578.593 t, finalGapTonnes 0.000 and the baseline 45112.276 tCO2e.")

q(2, "Take the unscheduled variant of the path. Which 2032 row does SECTION 22 print for it?",
 ...
 "SECTION 22, the path with the measure unscheduled: 2032, abated 13610.000 t, emissions 42490.276 t, target 41674.491 t, gap 815.785 t. 3220.083 t is its 2033 gap, and 15460.000 t is the scheduled path's abated column.")
