...
q(2, "attributeVariance lays the ODIOMA plan ledger beside the actual ledger. On what does it match a plan line to an actual line?",
 ...
 "attributeVariance matches the two ledgers on material and type, so a plan line and an actual line are the same line only when both agree. Each ODIOMA line carries one material and one type, such as escravos receipt or cdu unit_run.")
...
q(1, "At which unit value does the volume variance price a line's quantity gap?",
 ...
 "Volume variance = (actual quantity - plan quantity) x plan unit value. The actual unit value appears only in the price variance, (actual unit value - plan unit value) x actual quantity.")
...
q(3, "In the price variance, (actual unit value - plan unit value) is multiplied by which quantity?",
 ...
 "Price variance = (actual unit value - plan unit value) x actual quantity. On the escravos line the actual unit value of 80.2000 against the plan's 78.9000 is taken on the 735000.00 bbl received, and the line reads 955500.00.")
...
q(0, "In the actual ledger, what does the fuel_oil delivery's value of 12810000.00 record?",
 "What the fuel oil sold for in the month.",
 ["What the fuel oil cost the refinery to make.",
  "What the plan expected the fuel oil to sell for.",
  "What the crude behind the fuel oil cost."],
 "A delivery's value is what it sold for; every other event's value is what it cost. The plan expected 18902800.00 for the fuel_oil line, and the month's delivery of 210000.00 bbl sold for 12810000.00.")

q(2, "Over the month, what did each barrel of Escravos (illustrative) cost, as its variance line reads the actual unit value?",
 "80.2000",
 ["78.9000", "76.8000", "0.0000"],
 "Actual unit value = actual value / actual quantity: 58947000.00 over 735000.00 bbl reads 80.2000, against a plan unit value of 78.9000. 76.8000 is the Forcados plan unit value, and 0.0000 is what the Forcados line reads, with no barrels received.")
...
q(1, "The crude unit ran 735000.00 bbl for 1080450.00. Which actual unit value does its variance line print?",
 "1.4700",
 ["1.4000",
  "3.2000",
  "3.1000"],
 "Actual unit value = actual value / actual quantity, and the cdu line reads 1.4700 against a plan unit value of 1.4000. 3.2000 and 3.1000 are the reformer's actual and plan unit values.")
