...
q(0, "The NIOSH document offers two routes to its heat stress limits, the section 8.1 equation and Figures 8-1 and 8-2. Which route does the engine take, and what tests that choice?",
 "The equation, and the golden pins both figure readings as errata the engine must stay outside the printed tolerance of",
 ["The figures: they carry the document's own worked example, so they are the better tested of the two routes the document prints",
  "The equation at rates inside the figure range and the figures outside it, where the equation would otherwise be extrapolated",
  "The figures: reading a curve avoids the transcription risk that copying the constants carries"],
 "The engine evaluates the section 8.1 equation, and the golden pins niosh-heat-example-rel at 27.800000 C and niosh-heat-example-ral at 25.000000 C as cases the engine must miss, by 6.821223 and 1.904167 tolerances. An engine that followed the figures would turn the suite red. The constants 56.7, 11.5, 59.9 and 14.1 remain the section 8.1 equation, checked for transcription only, and the figures stop at 116 and 580 W.")
...
q(0, "At 233.000000 W the NIOSH heat REL equation gives 29.475407 C, the NIOSH 2016-106 section 8.1 equation, checked for transcription only, and Table 5-1 prints a band of 30.000000 C. Which route is the more permissive there?",
 ...
 ["The equation, which sits 0.524593 C below the band, so it lets through WBGT hours that the band summary would stop",
  "Neither, since a band summary is only the equation rounded to the nearest whole degree at the rate that the band names",
...
q(1, "Why does the golden not gate NIOSH 2016 Table 5-1 against the engine?",
 "Table 5-1 summarises the limits in bands of one round value, and the band differs from the equation at each of its four rates",
 ["Table 5-1 is licensed text, like the ACGIH tables, so none of its values may be quoted by the course or gated by the golden against the engine",
  "Table 5-1 carries the RAL alone, and the golden gates only the NIOSH heat REL equation against the values a source prints",
  "Table 5-1 is one of the five errata, and an erratum is pinned as a miss rather than gated as a reproduction"],
 "The course prints the four band values, 30, 28, 26 and 25 C, beside the equation at the band rates, and the differences are 0.524593, 0.542492, -0.024291 and 0.079422 C. A summary that differs at every rate it covers would fail a gate at a point without saying anything about the engine, so the golden does not gate the table. Table 5-1 is a NIOSH table and quoted freely, its bands are compared with the NIOSH heat REL equation, and it is absent from the five errata.")
