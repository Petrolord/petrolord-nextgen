...
q(3, "On track sits fourth in complianceStatus.STATUS_SEVERITY and Compliant fifth. Why is On track the worse of the two?",
 "On track still has work outstanding for its period.",
 ["On track rows have passed their due dates.",
  "The list is simply alphabetical.",
  "Compliant rows have no due date left."],
 "On track means a due date ahead and nothing filed for the current period. In the sorted register the two On track rows sit sixth and seventh and the two Compliant rows eighth and ninth."),
