...
q(3, "Which of the three loading figures does the engine return on a sweetening answer?",
 "The rich loading it used.",
 ["The lean loading it used.",
  "The swing it circulated on.",
  "All three, on named keys."],
 "Nothing on the answer object is called a swing. What comes back is the loading the engine applied, and forming the difference between the two ends is the reader's own step.")
...
q(2, "Which two properties move together across the three amine rows?",
 "The strength and the rich limit.",
 ["The strength and the molecular weight.",
  "The rich limit and the solution gravity.",
  "The duty per gallon and the molecular weight."],
 "Each row is a whole operating case rather than one property swapped out. Moving one input at a time is what the panel beside the lesson is for.")
...
q(1, "How many chosen numbers sit behind the three Professional readings of one column?",
 "Six, and the engine computes everything in between.",
 ["Three, one for each of the readings.",
  "Nine, three for each of the readings.",
  "None, since every figure in the tier is computed."],
 "The swing, the strength and the duty per gallon sit behind the first. The absorption factor sits behind the second. The K value and the liquid density sit behind the third.")
