...
q(2,
 ...
 ["Every factor was matched against a second edition of the same source at twelve decimals",
  ...
  "The factors were fitted to the R2P2 box of industry rates and agree with it within rounding"],
 "The digest says the engine's own validation planted a wrong clothing factor in both the engine and its oracle, and the suite stayed green, which is why no number through the fractions is graded. There is no second reading of the source behind them. No error was found and flagged, because a planted error in both places cannot be seen. The R2P2 box banks individual rates by industry and says nothing about these factors.")
