...
q(1,
 ...
 "The digest quotes the model string exactly as the key reads it. A base of 1,000,000 hours is the mistake that turns the JISIKE crew figure into 0.020167. Multiplying by the hours inverts the rate. The FAR is built from a PLL, the expected deaths of a group, and an IRPA over a year of 8760 hours is one person's individual risk.")
...
q(3,
 ...
 "The digest prints 121.000000 as the PLL over one person's hours, beside the engine's 2.016667 over the crew's 120000. Dividing a group's expected deaths by one member's hours overstates the rate by the head count. The wrong base gives 0.020167, which is too small. The spill adds zero to the PLL either way, and nothing in the calculation reads the PLL as a probability.")
...
q(2,
 ...
 "Section 34 rules that FAR is always per 100,000,000 exposed hours, because the same rate appears in the safety statistics course and a bare number invites a wrong base. Expected fatalities per year is the unit of the PLL. A FAR is never a probability, and a figure per person per year is the shape of an individual risk.")
