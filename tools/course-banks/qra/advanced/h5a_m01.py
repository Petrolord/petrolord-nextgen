...
q(0,
 ...
 "The digest quotes R2P2 paragraph 136 \"more than\", Bevi \"ten hoogste\" and the checklist \"greater than\", each of which puts equality in the lower band. The Figure 6.8 caption and R2P2's bias to safety are the two things that argue the other way, so they cannot support the claim. Neither \"at least\" wording appears in the digest, and the engine rounds nothing."),

q(2,
 "Which argument does the digest name as pointing the OTHER way from the owner's decision on a value exactly at a threshold?",
 ...
 ["The IEEE double product 0.0010000000000000002, which shows the exact product lying above 1e-3 per year and so in the upper band at every threshold.",
  "Bevi's wording \"ten hoogste\", which the digest translates as at least and which puts a value on the Dutch line in the band above.",
