...
q(2,
 ...
 "1e-5 times 1000000 is 10.00 for one year, which is the golden case the course shows and the published margin note reproduced. The engine takes the life the caller states, so the EDIKAN life of 20 years has no part in this call, and 40000.00 is the EDIKAN benefit. A lifetime of 1 year is a whole number of years, 1 or more, which the engine accepts."),
...
q(0,
 ...
 "The computed limit is 92835.00, so 93000 lies above it by 165.00 and the engine returns GROSSLY_DISPROPORTIONATE. The checklist meant \"in the region of\", and the verdict is an artefact of its rounding. The lower band applies at the computed limit, the snap is far narrower than 165.00, and the half unit on the benefit is only a small part of 165.00 even at a DF of 10: most of the margin is the print's rounding up to 93000."),
...
q(2,
 ...
 "The engine refuses a negative deltaPLL with the message quoted, which is its own. It never computes a negative benefit or ratio, it never silently flips a sign, and a verdict needs a benefit to weigh, which a measure that raises the PLL does not have."),
...
q(3,
 ...
 "The export's sources are verbatim in the course: R2P2 (2001) Appendix 3 para 13, about GBP 1 000 000 at 2001 prices, and the CBA checklist (2003 values), fatality GBP 1,336,800, times 2 for cancer. The years are not swapped, the two figures do not map to the worker and public presets, and neither is current."),
