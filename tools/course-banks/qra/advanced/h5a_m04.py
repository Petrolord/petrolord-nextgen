...
q(1,
 ...
 ["The largest reasonably practicable cost, 120000.00, because it is fixed by the cost and the benefit alone, whatever the DF.",
  ...
  "The ICAF, 8750000.00, the only figure in the result that the DF divides."],
 "The digest says the cost to benefit ratio does not depend on the DF; only the verdict and the largest reasonable cost do. The largest reasonable cost runs 40000.00, 80000.00, 120000.00, 200000.00 and 400000.00 down the sweep, and the verdict turns at DF 10. The ICAF is also unmoved by the DF, but only because the DF never enters it at all."),
...
q(1,
 ...
 "The digest quotes the checklist: a DF of more than 10 is unlikely, which is guidance to the analyst. The engine's only DF refusal is a factor below 1. There is no ceiling refusal, no default DF, and nothing in the digest makes 10 a floor for any kind of site."),
...
q(2,
 ...
 "The digest quotes the model string verbatim: strictly greater, other harms inside the benefit, and a CPF over dPLL times the years. The '>=' string would put equality in the upper band. The second drops the other harms and discounts the fatalities, and the third inverts the ratio and loses the years from the CPF."),
