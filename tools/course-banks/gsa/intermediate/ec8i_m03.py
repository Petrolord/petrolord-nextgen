...
q(3, "In 2027 the Ekene power plant's seller made 6300.000000 fewer MMBtu available than was properly nominated, and the fixture states liquidated damages of 1.25 US$ per MMBtu not made available (a synthetic contract term). What does the engine return for that shortfall of the seller?",
...
q(0, "A learner states a seller shortfall of 5 in a contract year and leaves the shortfall price out. What does the engine return?",
...
q(2, "In a golden year with an ACQ of 1000.000000, reductions of 200.000000 including a seller shortfall of 50.000000, 600.000000 counted, take-or-pay at 80 percent, prices of 3 and a shortfall price of 1.5, what net to the seller does the engine return?",
...
q(3, "The export feed's term ends in 2036 with 457950.000000 of make-up unrecovered, refunded at that year's take-or-pay price. The engine's reason prints the refund as 3700831.3350000004. Which figure does the course quote and reason with?",
 "3700831.335000, the numeric field",
 ["3700831.3350000004, the figure in the engine's reason, since the reason carries the double the engine holds",
