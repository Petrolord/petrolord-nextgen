...
q(1, "The engine's own sentence for the ocean loss is \"The loss divides the cost.\" Which reading of BADAGRY does that sentence rule out?",
 ...
 "A loss is litres paid for and never received, and nobody is paid for losing them. So it changes the litres the money is spread over, and the landed total stays at 26513943.86 USD.")
...
q(2, "Where does the ocean loss sit among the inputs to the invented BADAGRY build-up?",
 ...
 "The template's 9 lines are charges, each paid to someone on a base. The loss is paid to no one. On a real cargo it is what the shore tanks measure against the bill of lading, and the engine does not estimate it.")
...
q(3, "How does the invented exchange rate of 1520.4000 naira to the dollar enter the BADAGRY landed cost?",
 ...
 "Converting once keeps the exchange rate a single visible input. Every line of the walk is in dollars, and 0.581870 USD a litre sold becomes 884.6753 naira.")
...
q(1, "The invented exchange rate is left out of the BADAGRY call. What does the engine report?",
 ...
 "The dollar cost a litre sold needs no exchange rate. The naira figure needs exactly one, and with none the local figure is none. An old rate carried over would be a guess.")
...
q(0, "The walk prints FOB at 0.513357 USD per outturn litre on BADAGRY, every rate invented. Which quantity is that line spread over?",
 ...
 ["The bill of lading, 45772751.75 litres",
  ...
  "The outturn, 45566.774 m3"],
 "The column in USD per outturn litre is the division by the outturn done line by line, so every line is spread over the same 45566774.37 litres. The m3 figures are the same two quantities in another unit.")
...
q(1, "Why is H1 taught as a limit and never graded?",
 "A graded answer would have to pick one contract term and present it as the rule.",
 ["The engine bills the discharge lines on the outturn, and the course has no outturn figures.",
  "The invented jetty and storage rates are too small to matter.",
  "The engine refuses the jetty and storage lines until the contract basis is typed."],
 "Whether a terminal bills on the bill of lading or on the outturn is a contract term the engine does not know. The engine answers every per-quantity line on the bill of lading.")
...
q(0, "Where does a figure like BADAGRY's invented 0.45 percent loss come from, as far as the engine is concerned?",
 "It is typed in as an input; on a real cargo it is measured by the shore tanks against the bill of lading.",
 ["It is estimated from the voyage, the product and the weather, then applied to the bill-of-lading litres.",
  "It is read from PRODUCT_REFERENCE, which carries a typical loss beside each typical product density.",
  "It is the gap between the 45772.752 m3 invoiced and the 45772.700 m3 typed as a volume."],
 "The ocean loss is a percentage of the bill-of-lading quantity and it is an input. The engine does not estimate it from the voyage, the product or the weather.")
