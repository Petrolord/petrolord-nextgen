...
q(2, "An elbow is run with withSilhouette true. Which k does it return as its reading of the inertia curve?",
...
q(2, "Read down the fraction column of the seed 3 elbow. Which description holds?",
 ...
 ["Falls at every step after k 2, so the curve bends only once and smoothly down to k 8",
  "Its lowest figure is the last one, 0.068791 at k 8, as the curve flattens out toward the end",
  "Rises from 0.282430 at k 4 to 0.112303 at k 5, which makes k 4 a dip in the column"],
