...
q(3, "Sixteen of the thirty pinned constants have no export at all. What is the practical consequence?",
 ...
 ["For those sixteen the pin compares the golden against the digest generator instead, so the engine is out of the comparison and the pin is weaker by one copy.",
  ...
  "For those sixteen the digest reads the literals out of the source."],
...
q(3, "The H2S screening threshold was left where it was, and the digest says why. What argument says that tightening the category bands would not repair them either?",
