...
q(0, "The digest proves the withdrawn severity region is genuinely gone three separate ways. Which of these is one of them?",
 "None of the three material guidance strings and neither standard name appears anywhere in the engine source.",
...
q(0, "A colleague quotes the sour screening threshold as a round 0.05 psia. What is wrong with that, and why can the gap between the two be given as two different percentages?",
 "The round figure is not the one the engine works to, and the gap depends on which of the two numbers it is taken as a fraction of.",
 ["The two agree to six decimals in psia and part company only in bar, because the conversion back through the engine's own factor is what introduces the difference in the first place.",
...
q(2, "One of the studio's unit conversions is truncated far more coarsely than the engine's own factor. Which one, and by how much?",
