...
q(2, "What is the scale free property of the pH correction, and what did the digest measure for it?",
...
q(0, "On one of the engine's worked streams the rate falls from 4.724817 mm/yr at a pH of 4.000000 to 0.014941 mm/yr at 9.000000. What is the ratio between the two ends?",
 ...
 "The rate falls at every step of that column and each step down is smaller than the one above it. The generator asserts that on every rebuild rather than printing it once and trusting it."),
...
q(1, "Why would a factor of one below the reference be the wrong silence?",
 ...
 ["It is the most limiting answer available, so it would report a rate above anything the correlation could support at that acidity.",
  "It would break the one decade per two pH units property, which is asserted across the whole swept band and would fail on the first rebuild of the digest.",
