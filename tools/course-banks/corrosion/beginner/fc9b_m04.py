...
q(1, "The course sweeps the onset across seven carbon dioxide fugacities. What do those figures show?",
...
q(2, "Across the fugacities the course sweeps, how far does the onset move?",
...
q(2, "Every capstone scenario in this course sits below its own computed onset. Why does that clear the arrangement question?",
 ...
 "It is an identity rather than a tolerance, which is why it is worth stating as the reason. The course asserts it rather than assuming it."),
