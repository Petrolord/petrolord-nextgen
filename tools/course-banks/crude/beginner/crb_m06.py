...
q(1, "Where does Ubie Condensate's TBP curve stop?",
 "100 percent at 760 F.",
 ["90 percent at 600 F.",
  "100 percent at 1380 F.",
  "88 percent at 920 F."],
 "Ubie Condensate's curve runs from 0 at 70 to 100 at 760. 90 at 600 is its point before the last, 100 at 1380 is Obigbo Light's end point and 88 at 920 is the Ebocha partial assay's last point.")

q(1, "On the studio's default cuts, which of the export blend's cuts have no yield, and does its set close?",
 "None; the six yields total 100.0000 and the set closes.",
 ["LPG / Light ends, since Egbema Medium's curve starts at 95 F; it does not close.",
  "None; the yields are normalised to 100.0000 before the set closes.",
  "Vacuum residue, which has no upper bound; it does not close."],
 "The export blend's yields are 0.2708, 22.1456, 16.6342, 17.0344, 26.8621 and 17.0528, total 100.0000. Closes: true. Cuts with no yield: nothing. A total is reported as it computes and never normalised.")

q(2, "Which library crude has the largest Naphtha yield on the studio's default cuts?",
 ...
 "Ubie Condensate's Naphtha cut is 52.5974, the largest in the Naphtha column; 22.7807 is its Kerosene / Jet, 25.2590 is Obigbo Light's Naphtha and 16.3636 Egbema Medium's.")
...
q(2, "Which library crude carries the most asphaltenes in its SARA analysis?",
 "Asarama Heavy, at 11.9 wt%.",
 ["Egbema Medium, at 3.5 wt%.",
  "Obigbo Light, at 1.7 wt%.",
  "Ubie Condensate, at 89.1 wt%."],
 "The asphaltenes column reads 1.7, 3.5, 11.9 and 0.2 wt%. 89.1 is Ubie Condensate's saturates.")

q(0, "The export blend's result lists specific gravity beside a basis. Which pair is it?",
 "0.8611, on volume.",
 ["0.8611, on mass.",
  "0.8804, on volume.",
  "0.8408, on volume."],
 "blendCrudes blends specific gravity on volume and names that basis: 0.8611. 0.8804 is the three-crude blend's specific gravity and 0.8408 is Obigbo Light's own.")

q(3, "The export blend's own curve gives it six cut yields. Which is the one for Vacuum residue?",
 "17.0528.",
 ["17.0344.",
  "13.7736.",
  "23.1429."],
 "The blend's residue yield is 17.0528. 17.0344 is its Diesel / Gasoil, and 13.7736 and 23.1429 are Obigbo Light's and Egbema Medium's own residue yields.")
...
q(0, "Which figures does the library print for Obigbo Light's API and sulfur?",
