...
q(1,
 ...
 "The course states that across 28 golden cases the engine sits at or above route B every time, and names the two reasons. There is no case in the set where the engine falls below, so a mixed direction or a direction that depends on the architecture is wrong. Being below everywhere would be the unconservative direction and is the opposite of what is measured."),
...
q(1,
 "Why does Annex B overstate a 2oo2, on the counting the course gives?",
