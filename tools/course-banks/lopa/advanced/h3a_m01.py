...
q(3,
 ...
 "The course lists the band for every row of the valve column, and 70080 hours is SIL 1. The valves hold SIL 2 at 8760, 17520 and 35040 hours, so stopping at SIL 2 stops one row short, and SIL 3 holds only at 2190 and 4380 hours. A figure of 0.018095929431 sits inside the table, so no band at all is wrong too."),
...
q(2,
 ...
 "The engine returns a floor of 0.014400000000 for this channel, above the target of 0.01, so no interval however short meets it. 0.000008000000 is what the INTERVAL_INDEPENDENT channel reports. The engine never echoes a target back, and the state does carry the floor, which is what makes it a design finding a note can quote."),
