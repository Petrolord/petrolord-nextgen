...
q(3,
 ...
 "The three year row reads a PFDavg of 0.006819960176 and a risk reduction factor of 146.628422, and it still meets the tolerable frequency. 119.303034 and 99.342388 are the 3.5 year and four year rows, both of which miss, and 246.170895 is the two year row."),
...
q(0,
 ...
 "The digest lists the shape of the note item by item, and every one of them is there so a reader who disagrees can recompute the answer. A band and a verdict cannot be audited, a pair of figures leaves out the rates and the states, and a log of calls in order is a record of work and not a verification argument."),
