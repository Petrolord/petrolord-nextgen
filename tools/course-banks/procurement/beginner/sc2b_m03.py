...
q(0, "How does the engine know that a unit rate's decimal point is obviously misplaced?",
 "It reads the flag decimalMisplaced true, stated on that bill line.",
...
q(3, "decimalMisplaced is set to true on a line whose quantity is 0. What does the engine return?",
 ...
 ["A corrected unit rate of zero for the line, since any quoted amount divided across no units is taken as nothing.",
  "The line left as quoted with no reason printed, because a decimalMisplaced flag on a quantity of 0 changes nothing.",
  "Silence: the flag is dropped from the line without a word, and the rule that the unit rate prevails applies as usual."],
...
q(0, "Which texts does the course name for the rule that the unit rate prevails?",
 ...
 ["ITB 34.1 of the SPD for Works, two-envelope (September 2025), and s.32(3) of the Public Procurement Act 2007.",
