...
q(3, "Which of the two turndowns does the engine's warning fire on, and why does the choice matter?",
 ...
 ["The differential turndown, because it is the quantity the transmitter reports directly and a warning on a derived figure would be a warning about a calculation.",
  ...
  "Both, because a result that passes one limit always passes the other."],
 "The two limits are reached at different readings, so a warning on the differential turndown would flag a meter still comfortably inside the flow rule."),
...
q(0, "Asked for a reading above the transmitter span, the engine returns `the reading is above the transmitter span`. Why is there no number to give?",
 ...
 "This is the likeliest of these cases to arrive in real life, when a well is opened up and a span chosen for last year's rate is too small."),
...
q(0, "What does the choice of span decide for the years a meter is in service?",
 ...
 ["How wide the band around each reading is in percent of reading terms, since a wider span carries a proportionally wider band at every point on it.",
