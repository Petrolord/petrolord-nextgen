...
q(0, "OGUTA reads gpmC2Plus 1.3157 and gpmC3Plus 0.4890. What does the course name the column between them, and what does it print for OGUTA?",
 "The ethane, 0.8268",
 ["The ethane, 2.7737",
  "The propane, 0.8268",
  "The methane, 0.8268"],
 "The column is gpmC2Plus minus gpmC3Plus, and the course heads it \"the ethane\": 0.8268 on OGUTA, 2.7737 on EGBEMA and 2.4003 on the studio's opening gas. Methane is not recoverable as NGL and is in neither cut.")
...
q(1, "What does the course print for EGBEMA's propane and heavier mass against its whole mass in one Mscf?",
...
q(3, "RICHNESS_GPM exports the edges of a screening word. Beside that word, what does the course say governs a route's liquids?",
 ...
 "The course reads the richness word off gpmC3Plus against RICHNESS_GPM and calls it \"a screening word; a route's own liquids limit governs\".")
