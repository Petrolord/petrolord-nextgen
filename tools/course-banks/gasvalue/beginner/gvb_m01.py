...
q(2, "Which flareToValue function answers the studio question \"what is in this gas, and how much liquid could it give\"?",
 ...
 ["creditSensitivity",
  "screenRoute",
  "routeEconomics"],
 "The course's table of questions pairs that question with characteriseGas. creditSensitivity answers whether the project needs carbon credits to clear its hurdle, screenRoute answers which way of selling the gas it allows, and routeEconomics answers what a route makes, earns and costs in a year.")

q(0, "What does the course's export table count for flareToValue?",
...
q(3, "lpgCng calls three modules and writes none of the three itself. What does it call terminalDepot for?",
 ...
 "The course says lpgCng calls the loading-rack queue in terminalDepot for its carousel and forecourt, the gas Z factor in production/gasProperties and the compressor train in facilities/compression. The capital power law is in modularRefinery, which flareToValue uses.")
...
q(1, "One Mscf of methane carries 19.1757 kg and one Mscf of carbon dioxide carries 52.6038 kg. What does the course say the two rows hold the same?",
 "The count of moles",
...
q(3, "How does the course say kgPerMscf is built from the engine's constants?",
...
q(3, "The CO2 row carries one carbon per molecule and is marked inert. What does the course say about that carbon?",
 ...
 "The course's sentence on the row: its carbon is counted when the carbon per mole is counted, and it is not a fuel. The CO2 row's typical heating value is 0, and nitrogen carries 0 carbon per molecule where CO2 carries 1.")
