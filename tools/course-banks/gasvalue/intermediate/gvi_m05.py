...
q(1, "What is printed as the breakeven's numerator, the hurdle minus the margin, on EGBEMA's CNG route?",
 ...
 ["24500000 a year",
  "8721314.60 a year",
  "21008150.00 a year"],
 "The digest: \"The breakeven's numerator, the hurdle minus the margin: 3491850.00 a year, over 218032.865 t/yr.\" 24500000 is the hurdle, 21008150.00 the gross margin and 8721314.60 the credit revenue at a price of 40.")
...
q(2, "How does creditSensitivity form creditRevenuePerYear at each typed price?",
 ...
 "The digest: \"creditRevenuePerYear is the credit price times the net abatement in tonnes; totalMarginPerYear is the route's gross margin plus that\". At a price of 20 on 218032.865 t/yr it prints 4360657.30.")
...
q(3, "Against a hurdle of 24500000, what verdict does creditSensitivity give EGBEMA's CNG route?",
 ...
 "The digest prints standsAloneWithoutCredits false and the verdict \"Needs a credit price of 16.02 per tonne to clear the hurdle. This is a bet on the credit price.\" The field breakevenCreditPrice prints the same price as 16.0152. The stands alone verdict belongs to the hurdle of 20000000.")
...
q(0, "Lower the hurdle margin to 20000000 with the same margin and net. Which two fields follow?",
 ...
 "The digest: \"At a hurdle of 20000000 the route stands alone: standsAloneWithoutCredits true, breakevenCreditPrice 0.0000, verdict Clears the hurdle on its own. Credits are upside; the case stands without them.\" A null breakeven is what the probes with no margin or no hurdle print, and 20 is lowestTestedClearingPrice at the hurdle of 24500000.")
...
q(1, "creditSensitivity is run on the gas to power counterfactual, whose net abatement is -2010.348 t/yr. What does it answer?",
 ...
 "The digest's probe table prints that refusal for \"the gas-to-power counterfactual, which adds emissions\". The \"No net abatement to sell\" refusal is the one for a counterfactual left undeclared.")
...
q(3, "creditSensitivity is run with the counterfactual undeclared, so there is no net abatement. What does it answer?",
 ...
 "The digest: REFUSED: No net abatement to sell. Declare the counterfactual first: a credit computed from a gross flare figure is a credit that cannot be issued. The hurdle refusal is for a hurdle typed as 'x'.")
...
q(2, "The hurdle margin is typed as 'x'. What does creditSensitivity answer?",
 ...
 ["No verdict: breakevenCreditPrice null; \"No hurdle margin, so whether it needs credits cannot be said.\"",
  ...
  "REFUSED: No net abatement to sell."],
 "The digest's probe \"a hurdle that is not a number ('x')\" prints REFUSED: The hurdle margin is not a number. The answer with no verdict and the no hurdle sentence belong to the hurdle left blank ('').")
...
q(0, "A study leaves the hurdle box empty (''). Which answer comes back from the credit test?",
 ...
 "The digest's probe \"hurdle left blank ('')\" answers with no verdict: breakevenCreditPrice null; \"No hurdle margin, so whether it needs credits cannot be said.\" The other answer with no verdict belongs to a route whose price is missing.")
...
q(1, "On EGBEMA with the study's limits, what do compareRoutes' fields read?",
 ...
 "The digest prints bestByValuePerMscf cng, leaderNotFullyScreened null, screenedOut Mini LNG and notFullyScreened Gas to power or gas to wire. The null best with cng as leader not fully screened is the studio's opening case, with every limit unset.")
