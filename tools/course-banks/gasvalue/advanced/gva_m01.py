...
q(2, "lpgBlendProperties prints a basis beside each of the three properties it returns for KANO's blend. Which pairing does it print?",
 ...
 "The blend lesson prints KANO's row as 557.4000 (volume), 397.7592 (mass) and 52.7681 (mole), and states: density blends on volume; latent heat per kilogram blends on mass; molar mass blends on moles. Each other pairing moves at least one property onto a basis the engine does not use for it.")
...
q(0, "KANO's blend is propane 0.35 and butane 0.65 by liquid volume, on the typical figures. What latent heat does the engine return for it?",
 ...
 ["399.0000 kJ/kg",
  "399.6821 kJ/kg",
  "385 kJ/kg"],
 "The KANO row prints latentHeatKJkg 397.7592 on mass. 399.0000 kJ/kg is KANO's latent heat averaged on the volume fractions, which the blend lesson prints as 1.2408 kJ/kg from the engine's; 399.6821 kJ/kg is the studio opening blend; 385 kJ/kg is n-butane's typical row in LPG_REFERENCE.")
...
q(3, "lpgStorageSizing is called for KANO's vessel with the fill limit left blank. What comes back?",
 ...
 "The vessel lesson: the fill limit is required and has no default; the blank probe prints \"REFUSED: A maximum fill ratio is required and is not defaulted. It is a code limit for the product and the vessel: LPG expands and a vessel filled liquid-full ruptures hydraulically.\" 0.85 is one of two illustrative limits typed for KANO, neither a code value.")
...
q(2, "The fill ratio basis is OMITTED from the call for KANO's vessel at a fill limit of 0.85. What does the engine do?",
 ...
 "The vessel lesson: omitted from the call, the engine takes liquid_volume and names it in its output: fillRatioBasis liquid_volume, usableTonnes 71.0685 at a fill limit of 0.85. The refusal is what a basis typed blank ('') gets. 62.9433 t is the 0.42 limit on water_capacity_mass.")
...
q(0, "On the water-capacity basis, at what density does the engine weigh the vessel's water capacity?",
 ...
 "The vessel lesson: on the water-capacity basis the engine weighs the water capacity at WATER_KG_M3 = 999.1 kg/m3. 557.4000 kg/m3 is KANO's blend density, the liquid density the vessel rows use; 584 kg/m3 is n-butane's typical row; 553.6000 kg/m3 is the studio opening blend.")
...
q(1, "KANO's lead time is left blank ('') at the 0.85 fill. What does lpgStorageSizing return?",
 ...
 "The vessel lesson: a blank lead time is missing: missingInputs lead time; reorderAtTonnes null; deliveryFitsUllage no verdict; the cover (8.8840 days) does not depend on it and is still given. missingInputs none with a reorder point of 16.0000 is what the engine gives when the lead time is OMITTED and takes the stated 0.")
...
q(2, "A filling density of 0.6 on water capacity is put to KANO's vessel at the blend density. What does the engine print?",
 ...
 "The vessel lesson's probe table prints the liquid-full refusal for this case. The between 0 and 1 refusal is the probe with a fill limit of 1; the unknown basis refusal is the basis typed as 'weight'.")
...
q(0, "What vapour space does lpgStorageSizing leave in KANO's 150 m3 vessel at the 0.42 water_capacity_mass limit?",
 ...
 ["22.5000 m3",
  "112.9230 m3",
  "127.5000 m3"],
 "The 0.42 row prints usableM3 112.9230 and vapourSpaceM3 37.0770; the course states vapourSpaceM3 is the vessel less usableM3. 22.5000 m3 is the vapour space at the 0.85 liquid_volume fill, and 127.5000 m3 that row's usable volume.")

q(3, "At the 0.85 fill, usableTonnes over the demand is printed as 8.8836, and the engine's coverDays as 8.8840. What does the course give as the reason?",
