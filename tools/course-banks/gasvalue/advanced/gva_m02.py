...
q(1, "Which term of KANO's vaporizer duty does the engine print at 0.8368 of the duty?",
 ...
 "The vaporizer lesson's term table prints Boil it at 71.8176 kW and 0.8368 of the duty. Warming the liquid is 8.8472 kW at 0.1031 and superheating is 5.1567 kW at 0.0601; designDutyKW 98.6948 kW carries no share.")
...
q(3, "KANO's vaporizer takes 650 kg/h with a design margin of 15 percent. What design duty does the engine give?",
 ...
 ["85.8215 kW",
  "71.8176 kW",
  "8.8472 kW"],
 "designDutyKW is dutyKW times one plus the margin percent over 100, and the vaporizer lesson prints it as 98.6948 kW. 85.8215 kW is dutyKW before the margin, 71.8176 kW the boil term alone, and 8.8472 kW the warming term.")
...
q(0, "KANO's vaporizer duty is asked for with the boiling point left blank. Which result comes back?",
 ...
 "The vaporizer lesson: with the boiling point left blank the engine gives the boil alone: dutyKW 71.8176, missingTerms Warm the liquid to boiling; Superheat the vapour, and a note that the duty is a floor. The latent heat refusal is the probe with no latent heat.")
...
q(2, "n-butane's atmospheric boiling point of -0.5 C from LPG_REFERENCE is typed for KANO's vaporizer, with the liquid entering at 18 C. What does the engine print?",
 ...
 "The vaporizer lesson prints the refusal in full: \"The liquid enters at 18 C, above the boiling point given (-0.5 C). A liquid above its boiling point is not liquid: give the boiling point at the vaporizer's operating pressure.\" The boil alone is the blank boiling point; the condense refusal is the outlet at 30 C.")
...
q(3, "KANO's vaporizer is given a design margin of -5 percent. What comes back?",
 ...
 "The vaporizer lesson's probe table prints \"REFUSED: The design margin cannot be negative.\" for a margin of -5 percent. The margin is refused; it is neither taken as zero nor applied.")
...
q(1, "How does vaporizerDuty form its Boil it term, before dividing by KJ_PER_KWH?",
 ...
 "The vaporizer lesson: boil it is the mass flow times the latent heat. The heat capacity products are the superheat and warming terms, and dutyKW times one plus the margin percent over 100 is designDutyKW.")
...
q(0, "KANO's carousel is run at availability 1 on 17 positions. What average wait does the course print?",
 "0.0450 minutes",
 ["0.0912 minutes",
  "0.0222 minutes",
  "0.9850 minutes"],
...
q(0, "bottlingPlant is given one position at availability 0.4. What does it print?",
 ...
 "The carousel lesson's probe table prints \"REFUSED: Only 0.4 positions are working on average: fewer than one.\" for this case. The other two refusals are for blank shift hours or availability 1.2, and for no fill time.")
...
q(2, "Which two of the carousel probes print the same refusal?",
 ...
 "The carousel lesson prints \"REFUSED: Shift hours must be positive and availability must lie in (0, 1].\" for both shift hours left blank ('') and availability 1.2. One position at 0.4 and no fill time each print a refusal of their own.")
...
q(2, "KANO's cycle is put to assetFloat with the At the customer stage left blank. What does the engine print?",
 ...
 "The fleet lesson prints \"REFUSED: No duration for At the customer. A stage left out shrinks the fleet by the assets in it, so the fleet is not sized without it.\" The at least one stage refusal is the probe with no stages; the spares refusal is a negative spares allowance.")
