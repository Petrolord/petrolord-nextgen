...
q(3, "What typical boiling point does LPG_REFERENCE print for propane?",
 ...
 ["-0.5 C",
  "38 C",
  "18 C"],
 "LPG_REFERENCE prints propane's typical boiling point as -42 C and n-butane's as -0.5 C. 38 C is the boiling point at KANO's vaporizer pressure and 18 C the liquid's inlet temperature (SECTION 27).")
...
q(1, "lpgBlendProperties is given a negative volume fraction. Which line comes back?",
 ...
 "SECTION 25's probe table prints \"REFUSED: A volume fraction cannot be negative.\" A blank butane volume fraction gets \"Every component needs a volume fraction.\"; the fill ratio refusal belongs to lpgStorageSizing.")
...
q(3, "KANO's vessel is given a fill limit of 1. What does lpgStorageSizing print?",
 ...
 "SECTION 26's probe table prints \"REFUSED: The maximum fill ratio must lie between 0 and 1.\" for a fill limit of 1. The liquid-full refusal is the probe with a filling density of 0.6 on water capacity; the not defaulted refusal is a blank fill limit.")
...
q(2, "The fill ratio basis is typed as 'weight'. What does the engine do?",
 ...
 "SECTION 26's probe table prints the unknown basis refusal for 'weight'. liquid_volume is what the engine takes when the basis is OMITTED from the call; a basis that is typed and unknown is refused.")
...
q(0, "What deliveriesPerMonth does lpgStorageSizing print for KANO, and by which rule?",
 ...
 "SECTION 26: deliveriesPerMonth is the demand times 30 over the delivery, and both rows print 12.0000. usableTonnes over the demand is coverDays, 8.8840 at the 0.85 fill; the demand times the lead time plus the safety stock is reorderAtTonnes, 40.0000.")
...
q(1, "The call for KANO's vessel at 0.85 leaves the lead time field out altogether. Which pair comes back?",
 ...
 "Left out of the call, the lead time takes the stated 0 (SECTION 26): no missing inputs, and a reorder point of 16.0000, the safety stock alone. Typed blank (''), the lead time is named missing and the reorder point is null; 40.0000 belongs to the 3 day lead time.")

q(3, "KANO's 0.42 is read as a share of the liquid volume, on the basis it was not stated on. What does the digest print?",
 ...
 "Read on the liquid volume, the 0.42 gives 35.1162 t, and the digest prints that as 27.8271 t below the 62.9433 t the filling density gives. 71.0685 t is the 0.85 limit's usable stock.")
...
q(2, "How does vaporizerDuty form the term Warm the liquid to boiling?",
 ...
 "SECTION 27: warm the liquid is the mass flow times the liquid heat capacity times (boiling point less inlet). The vapour heat capacity term is the superheat and the latent heat term is the boil.")
...
q(3, "KANO's vaporizer is run with no latent heat. What does vaporizerDuty print?",
 ...
 "SECTION 27's probe table prints the latent heat refusal. A latent heat is a property of the product, and the engine assumes none.")
...
q(0, "What arrivalsPerHour does the carousel print for KANO's 3200 cylinders over a 10 hour shift?",
 ...
 "SECTION 28 prints arrivalsPerHour 320.0000. 4516.3600 is throughputCapacityPerDay, 3200 the cylinders a shift, and 11.7333 the queue's offered load in erlangs.")
...
q(0, "What does KANO's carousel print for minimumPositionsForThroughput and meetsDemand?",
 ...
 ["16 and true",
  "17 and true",
  "13 and false"],
 "SECTION 28 prints minimumPositionsForThroughput 13 and meetsDemand true. 16 is queuePositions; 17 is the positions rounded to the nearest whole one, the shortcut the engine does not take.")
...
q(2, "On its 16 working positions, what probabilityOfWaiting does KANO's carousel print?",
 ...
 ["0.1078",
  "0.0633",
  "0.7333"],
 "SECTION 28 prints queue probabilityOfWaiting 0.1769. 0.1078 and 0.0633 are the carousel run at availability 1 on 17 and on 18 positions; 0.7333 is the queue utilisation.")
...
q(3, "KANO's carousel is sized with no fill time. Which line comes back?",
 ...
 "SECTION 28's probe table prints the demand, fill time and position count refusal. The arrivals and dispenser count refusal is cngDispensing's (SECTION 33).")
...
q(2, "A cylinder float is asked for with an empty list of cycle stages. The engine's answer?",
 ...
 "SECTION 29's probe table prints the at least one stage refusal for no stages. \"No duration for At the customer.\" is KANO's cycle with that stage left blank.")
...
q(1, "Which bank of IBAFO's gas storage holds 448.1628 kg?",
 ...
 "SECTION 30 prints massKg 448.1628 on the High row. The Mid bank holds 425.6293 kg, the Low bank 400.5918 kg, and 250.0130 bar(a) gives 425.6447 kg.")
...
q(2, "For the 249 bar gauge reading, what does the absolute minus gauge-as-absolute row print?",
 ...
 "SECTION 30's gauge table prints absolute minus gauge-as-absolute as 1.0130 bar(a) and 1.2054 kg. 249 and 424.4393 kg are the gauge reading typed as if absolute; 250.0130 and 425.6447 kg are gauge plus atmosphere.")
...
q(0, "The bank mass is requested without any pressure. What is printed?",
 ...
 "gasMassInVessel refuses a missing pressure with that line (SECTION 30). 1.013 bar(a) is the site's atmosphere in SECTION 30's gauge example.")
...
q(0, "Which ppr does IBAFO's Low bank print at 30 C, and is the correlation in range?",
 ...
 "SECTION 30's bank table prints the Low bank at ppr 4.9479 with correlationInRange true. 5.8084 is the High bank's ppr, and 0.9727 is the tpr of the Low bank at -80 C, where correlationInRange is false.")
...
q(2, "cascadeEfficiency is a ratio of two cascade masses. Which two, and at what value for IBAFO?",
 ...
 "SECTION 31 prints cascadeEfficiency (delivered over stored) 0.4775 for IBAFO. 0.1505 is the same 6.0000 m3 as one bank, and 0.4577 the studio's opening cascade.")
...
q(0, "The studio's opening cascade, three 1.5 m3 banks at 250 bar(a), prints how many fills before recharge?",
 ...
 "SECTION 31: the studio's opening cascade prints fillsBeforeRecharge 33, cascadeEfficiency 0.4577, leftInBanksKg 542.689 and nextVehicleReachesBar 195.5640. 38 and 197.7590 are IBAFO's.")
...
q(1, "cascadeFills is given a target pressure below the start. What does it print?",
 ...
 "A target below the start is refused with the start and higher target line (SECTION 31). The bank refusal is for a call with no banks, and the temperature refusal for a temperature left blank.")
...
q(1, "One of IBAFO's banks is given a volume and no pressure. What does cascadeFills print?",
 ...
 "SECTION 31's probe table prints \"REFUSED: Every bank needs a volume and a pressure.\" for a bank with no pressure. \"A pressure is required.\" is gasMassInVessel's line (SECTION 30).")
...
q(1, "Which stage of IBAFO's compressor runs from 35.7070 to 95.4220 bar(a)?",
 ...
 ["Stage 2",
  "Stage 4",
  "Stage 1"],
 "SECTION 32's stage table: stage 1 runs 5.0000 to 13.3620, stage 2 13.3620 to 35.7070, stage 3 35.7070 to 95.4220 and stage 4 95.4220 to 255.0000, each at a ratio of 2.6723.")
...
q(1, "The station compressor bridge gets a suction and a discharge but no throughput. Result?",
 ...
 "SECTION 32's probe table prints \"REFUSED: A throughput is required.\" for no throughput. 0.4473 is IBAFO's qMMscfd for its 400 kg/h, and the pressure refusal is gasMassInVessel's.")
...
q(2, "How busy are IBAFO's two dispensers at 14 buses an hour, as the engine's utilisation?",
 ...
 ["0.4667",
  "1.2500",
  "0.5765"],
 "SECTION 33 prints utilisation 0.7000 on 2 dispensers and 0.4667 on 3. 1.2500 is 25 buses an hour on 2 dispensers, and 0.5765 the probabilityOfWaiting on 2.")
...
q(2, "What does cngDispensing's note say about a forecourt?",
 ...
 "SECTION 33 prints the note verbatim, and states that a CNG forecourt is the same queue as the carousel and the loading rack. 1.2500 is the utilisation of the overloaded forecourt, and the queues on 2 and 3 dispensers at 14 buses an hour both print a probability of waiting.")
...
q(3, "Two dispensers serve IBAFO's 14 buses an hour. How likely is a bus to wait, by the engine?",
 ...
 ["0.2024",
  "0.7000",
  "0.1769"],
 "SECTION 33 prints probabilityOfWaiting 0.5765 on 2 dispensers and 0.2024 on 3; 0.7000 is the utilisation on 2. 0.1769 is KANO's carousel (SECTION 28).")
...
q(1, "What CNG kg a year and CNG cost a year does the Lagos bus switch print?",
 ...
 "SECTION 34 prints CNG kg a year 5579.7100 and CNG cost a year 2120289.8600. 7700.0000 is the PMS litres a year, 6006000.0000 the PMS cost a year, and 2365.8000 kgCo2eAvoidedPerYear.")
...
q(0, "The switch economics are run without the bus's yearly kilometres. Which line does the engine print?",
 ...
 ["REFUSED: Either a measured consumption on the new fuel, or both fuels' energy content and an efficiency ratio, are required.",
  ...
  "REFUSED: A throughput is required."],
 "SECTION 34's probe table prints the annual distance refusal. The either or refusal is the probe with no measured consumption and a blank efficiency ratio.")
...
q(3, "The converted bus is assumed to use CNG energy exactly as well as PMS energy, a ratio of 1. Which consumption and payback does the switch print?",
 ...
 "SECTION 34's ratio table prints 9.3333 and 0.3004 at a ratio of 1, 10.1449 and 0.3137 at 0.92, and 11.6667 and 0.3421 at 0.8. 0.3030 is the payback on the measured 9.5 kg per 100 km.")

# SECTIONS 35 and 36
q(3, "Which of these is a HELD limit in SECTION 35?",
 ...
 "SECTION 35 holds four limits: the flare efficiencies have no default, an unlit flare is not modelled, fill limits by code are not shipped, and GWP values and credit prices are case inputs. The DAK and Sutton coefficients are pinned and not validated, and the compressor's thermodynamics are validated in Facilities.")
...
q(1, "The end-to-end table closes on IBAFO. Which three of its figures appear there?",
 ...
 "SECTION 36 prints IBAFO Mid bank 425.6293 kg, fills before recharge 38 and trailers required 8. 425.6447 kg is the gauge plus atmosphere reading, 12 fills the one bank case, and 7.2000 the trailers in circulation.")
