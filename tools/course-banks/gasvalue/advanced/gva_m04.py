...
q(1, "IBAFO's cascade counts 38 fills and stops. What does it print for hitFillLimit and for the next vehicle?",
 ...
 "SECTION 31 prints hitFillLimit false and nextVehicleReachesBar 197.7590: hitFillLimit reads true only when the count reaches the maxFills cap the call carries, and here it stopped on a vehicle that could not reach its target. 195.5640 bar(a) is the studio's opening cascade.")
...
q(0, "What does the digest say of the heat of a fast fill in the cascade?",
 ...
 "SECTION 31: both engine and oracle are isothermal: the heat of a fast fill is not modelled, so a real fill settles lower and the count is a ceiling in that one respect. 33 is the studio's opening cascade.")

q(3, "Which storedKg does IBAFO's cascade print, and what does the digest print beside it?",
 ...
 "The cascade table prints storedKg 1274.384 and, beside it, the Low, Mid and High bank masses summed (SECTION 30) as 1274.384. storedKg minus deliveredKg minus leftInBanksKg prints 0.000.")
...
q(1, "What does cngCompression do with the Facilities compression engine?",
 ...
 "SECTION 32: cngCompression does not compute compression itself. It converts the station's metric inputs to the field units the Facilities compression engine speaks, calls it, and converts the answer back. Its basis reads that it converts units and does not reimplement the thermodynamics, and SECTION 32 says the thermodynamics belong to the Facilities course.")
...
q(3, "How many stages does the Facilities engine return for IBAFO's compressor, and at what ratio each?",
 ...
 "SECTION 32 prints stageCount 4 and a ratio of 2.6723 on every stage, from 5.0000 to 255.0000 bar(a). 13.3620 and 35.7070 are stage discharge pressures in bar(a).")
...
q(2, "cngCompression is given a discharge below its suction. What does it print?",
 ...
 "SECTION 32's probe table prints this refusal for discharge below suction. The start and target refusal is the cascade's (SECTION 31); the throughput refusal is the probe with no throughput.")
...
q(2, "IBAFO's forecourt takes 14 buses an hour at 6 minutes a fill. What average wait does it give on 3 dispensers?",
 ...
 ["5.7647 minutes",
  "0.5765 minutes",
  "0.2024 minutes"],
 "SECTION 33 prints averageWaitMinutes 5.7647 on 2 dispensers and 0.7588 on 3. 0.5765 and 0.2024 are the probabilityOfWaiting on 2 and on 3.")
