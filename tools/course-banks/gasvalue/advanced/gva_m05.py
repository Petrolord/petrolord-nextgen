...
q(2, "No CNG consumption is measured for the Lagos bus. What consumption on CNG does conversionEconomics use, and from what source?",
 ...
 "The bus switch lesson prints consumptionSource derived from energy equivalence and newFuelConsumptionPer100Km 10.1449 kg at the efficiency ratio of 0.92. 11.6667 kg is the ratio of 0.8 and 9.3333 kg the ratio of 1; 9.5 kg is the measured consumption of the separate probe.")
...
q(0, "How does the engine derive the CNG consumption when none is measured?",
 ...
 "The bus switch lesson prints the check row PMS consumption x PMS energy over (CNG energy x efficiency ratio) as 10.1449, the same as newFuelConsumptionPer100Km.")
...
q(1, "What cost per kilometre on CNG does the engine print for the Lagos bus?",
 ...
 ["109.2000 naira",
  "69.5584 naira",
  "10.1449 naira"],
 "The bus switch lesson prints CNG cost per km 38.5507 and PMS cost per km 109.2000; savingPerKm is 69.5584. 10.1449 is the CNG consumption in kg per 100 km.")
...
q(3, "At the efficiency ratio of 0.92, what annualSaving after maintenance does the engine give?",
 ...
 ["3507666.6700 naira",
  "3995333.3300 naira",
  "6006000.0000 naira"],
 "The bus switch lesson prints annualSaving (after maintenance) 3825710.1400. 3507666.6700 is the ratio of 0.8 and 3995333.3300 the ratio of 1; 6006000.0000 is the PMS cost a year.")
...
q(2, "At the efficiency ratio of 0.92, what simple payback does conversionEconomics print?",
 ...
 ["0.3421 years",
  "0.3004 years",
  "0.3030 years"],
 "The bus switch lesson prints simplePaybackYears 0.3137, and the check row conversion cost over annualSaving as 0.3137. 0.3421 is the ratio of 0.8, 0.3004 the ratio of 1, and 0.3030 the measured consumption of 9.5 kg per 100 km.")
...
q(0, "A measured CNG consumption of 9.5 kg per 100 km is given to the engine. What does it do?",
 ...
 "The bus switch lesson: with a measured CNG consumption of 9.5 kg per 100 km the engine uses it: consumptionSource \"as measured\", simplePaybackYears 0.3030. 0.3137 is the payback on the derived consumption.")
...
q(2, "CNG is priced at 1100 naira a kg for the same bus. What does conversionEconomics return?",
 ...
 "The bus switch lesson: with CNG at 1100 naira a kg there is no saving: annualSaving -191681.1600, simplePaybackYears null, and the note \"The conversion does not save money at these prices, so there is no payback to report.\"")
...
q(1, "What does conversionEconomics print as its paybackNote?",
 ...
 "The bus switch lesson prints the paybackNote verbatim. The no saving sentence is the note at 1100 naira a kg; annualSaving is printed after maintenance.")
...
q(0, "What annual cash flow does conversionEconomics hand on for the Lagos bus?",
 ...
 "The bus switch lesson prints annualCashFlow year0 -1200000.0000 and recurring 3825710.1400. 2120289.8600 is the CNG cost a year, 6006000.0000 the PMS cost a year, and 3995333.3300 the annualSaving at an efficiency ratio of 1.")
...
q(2, "No measured CNG consumption is given and the efficiency ratio is left blank. What does the engine print?",
 ...
 ["A consumption derived at an efficiency ratio of 1, 9.3333 kg per 100 km",
  ...
  "REFUSED: Annual distance, base consumption and both fuel prices are required."],
 "The bus switch lesson's probe table prints this refusal, which ends \"Neither is assumed.\" The other refusal is the probe with no annual distance.")
...
q(3, "Beside the saving, the switch prints a yearly figure in kg of CO2e avoided. Which is it?",
 ...
 ["5579.7100",
  "7700.0000",
  "3825710.1400"],
 "The bus switch lesson prints kgCo2eAvoidedPerYear 2365.8000, on the illustrative emission factors 2.3 kg CO2e a litre of PMS and 2.75 a kg of CNG. 5579.7100 is the CNG kg a year, 7700.0000 the PMS litres a year, and 3825710.1400 the annualSaving.")
...
q(1, "What does the efficiency ratio of 0.92 state for the converted bus?",
 ...
 "The bus switch lesson: the converted engine turns CNG energy into distance 0.92 times as well as PMS energy. The energy contents are typed separately, 32 MJ a litre of PMS and 48 MJ a kg of CNG.")
...
q(1, "IBAFO's trailers run 4 trips a day with spares 0.1. What does assetFloat print as inCirculation, sparesAllowance and fleetRequired?",
 ...
 "The fleet lesson prints IBAFO's trailers as inCirculation 7.2000, sparesAllowance 0.7200 and fleetRequired 8, the fleet being the ceiling of the assets in circulation plus the spares allowance. 1.8000 is cycleDays and 0.0800 is spareCapacityUnits, what the ceiling adds.")
...
q(3, "IBAFO's trailers print spareCapacityUnits 0.0800. What does the course call that field?",
 ...
 "The fleet lesson labels spareCapacityUnits \"what the ceiling adds\". The spares allowance prints 0.7200, the spares fraction typed is 0.1, and Loading's share of the cycle is 0.1111.")
