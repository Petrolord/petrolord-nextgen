...
q(0, "What pressureBasis does lpgCng print on every CNG result?",
 ...
 "SECTION 30: every pressure in lpgCng is absolute, and the engine says so on every CNG result: pressureBasis \"absolute (bar(a))\".")
...
q(1, "Every IBAFO bank prints realVersusIdeal above one. What does the digest say that shows?",
 ...
 "SECTION 30: at these pressures Z is below one, so every bank holds more gas than the ideal gas law says (realVersusIdeal above one). The three rows print correlationInRange true.")
...
q(0, "In m = P V M over Z R T, what does gasMassInVessel take as M?",
 ...
 "SECTION 30: M is the gas's molar mass, its specific gravity times the molar mass of air, in kg/kmol.")
...
q(3, "In what unit does the pressure P enter the mass equation in gasMassInVessel?",
 ...
 "SECTION 30: P is the pressure in Pa (bar(a) times 100000). Every pressure in lpgCng is absolute.")
...
q(0, "What range does DAK_RANGE print for the Dranchuk-Abou-Kassem correlation?",
 ...
 "SECTION 30: DAK_RANGE: ppr 0.2 to 30, tpr 1 to 3. Outside it the engine still answers and says so.")
...
q(3, "IBAFO's Low bank is run at -80 C. What does gasMassInVessel do?",
 ...
 "SECTION 30 prints the probe with tpr 0.9727, correlationInRange false, and the note \"Outside the range the Dranchuk-Abou-Kassem correlation was fitted over. The value is an extrapolation and should be checked against measured data.\" Outside the range the engine still answers.")
...
q(1, "Which Z method does gasMassInVessel use for massKg?",
 ...
 "SECTION 30: Z by Dranchuk-Abou-Kassem on Sutton pseudo-criticals. Z taken as one is how the engine forms idealMassKg, which it prints beside massKg; the pressures are absolute.")
...
q(2, "IBAFO's bank is put to gasMassInVessel with the gas gravity left blank (''). What does the engine print?",
 ...
 ["REFUSED: A pressure is required.",
  ...
  "REFUSED: A temperature is required."],
 "SECTION 30's probe table prints \"REFUSED: A gas specific gravity is required.\" for a blank gas gravity. The pressure and temperature refusals are the probes with no pressure and no temperature.")
...
q(1, "gasMassInVessel prints idealMassKg beside massKg on every bank. What is idealMassKg?",
 ...
 "SECTION 30: the ideal mass is the same m = P V M over Z R T with Z taken as one. The gauge reading typed as absolute is its own row of the gauge table, and M is the specific gravity times the molar mass of air.")
