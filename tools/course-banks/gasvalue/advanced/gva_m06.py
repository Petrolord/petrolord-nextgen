...
q(1, "What does SECTION 35 hold about the flare efficiencies?",
...
q(3, "The vessel's water capacity is weighed with water at 15 C for a filling density. Where does SECTION 35 place that water figure?",
 ...
 "SECTION 35's pinned list ends with water at 15 C for a filling density. The held limits are the flare efficiencies, the unlit flare, fill limits by code, and GWP values and credit prices as case inputs.")
q(0, "Which fill limit does lpgCng ship for an LPG vessel?",
 ...
 "SECTION 35, held: fill limits by code (NFPA 58, EN or NUPRC practice) are not shipped: the limit is a safety code value, typed by the site with its basis. SECTION 26 calls 0.85 and 0.42 two illustrative fill limits, neither a code value.")

q(2, "What does SECTION 35 say of GWP values and credit prices?",
 ...
 "SECTION 35, held: GWP values and credit prices are case inputs. They appear in neither the pinned list nor the list of what the oracles check.")

q(1, "Which of these does SECTION 35 list as pinned and not validated?",
 ...
 "SECTION 35's pinned list: the component heating values and liquid densities, the typical LPG densities and latent heats, the DAK and Sutton coefficients, the form of the rule's equations, and water at 15 C for a filling density. The cascade ledger, Erlang C and the blend, storage and vaporizer ledgers are what the oracles check.")
...
q(3, "What do the validation oracles check of cngCompression?",
 ...
 "SECTION 35: the compressor train's thermodynamics are the Facilities engine's and are validated there; only the unit bridge is checked here. The pinned list does not name the compressor, and bisection on reduced density is how the oracle finds Z.")
...
q(0, "How does the oracle find Z, independently of the engine?",
 ...
 "SECTION 35: Z by bisection on reduced density with a second correlation as a plausibility check. The mass ledger with conservation asserted is the cascade's check, and exact rationals in kilograms and cubic metres are how the oracle takes the gas.")
...
q(2, "The Kano and Ibafo rollout prints KANO cylinders required. Which figure is it?",
 ...
 "SECTION 36 prints KANO cylinders required 98496, SECTION 29's fleetRequired. inCirculation prints 91200.0000 and sparesAllowance 7296.0000; 3200 is the cylinders filled a day.")
...
q(3, "Two rollout steps size KANO's stock: usable LPG and cover. Which pair does the end-to-end table show?",
 ...
 "SECTION 36 prints KANO usable LPG at a 0.85 liquid fill 71.0685 t and cover 8.8840 days. 62.9433 t and 7.8680 days are the 0.42 water_capacity_mass row; 8.8836 is usableTonnes over demand before the engine's three decimal cover; 127.5000 is usableM3 in m3.")
...
q(1, "The rollout's KANO vaporizer design duty of 98.6948 kW runs on which latent heat?",
 ...
 "The vaporizer in SECTION 27 is fed the latent heat the blend gives on mass, 397.7592 kJ/kg. 399.0000 kJ/kg is the volume-fraction average SECTION 25 sets beside it, and 385 and 425 kJ/kg are the two component rows.")
...
q(2, "IBAFO's forecourt prints kgPerHour 224.1860. Which mass per fill does it carry?",
 ...
 "SECTION 33: IBAFO's forecourt is 14 buses an hour, 6 minutes a fill, each fill the cascade's 16.0133 kg. 425.6293 kg is the Mid bank in SECTION 30, 608.505 kg the cascade's deliveredKg, and 10.1449 kg the bus's newFuelConsumptionPer100Km.")
...
q(3, "Which gas do IBAFO's cascade and its banks both run on?",
 ...
 "SECTIONS 30 and 31 give IBAFO's gas as specific gravity 0.62 at 30 C. 0.6 at 15 C is the studio's opening cascade; 32 C is the compressor's suction temperature; -80 C is the out of range probe on the Low bank.")
...
q(0, "How do the oracles check the cascade?",
 ...
 "SECTION 35: the cascade as a mass ledger with conservation asserted. Exact rationals on the positions wholly working is the oracle's Erlang C, and bisection on reduced density its Z. SECTION 31 prints storedKg minus deliveredKg minus leftInBanksKg as 0.000.")
...
q(1, "Which carousel figures does the rollout print for KANO?",
 ...
 "SECTION 36 prints KANO carousel positions wholly working 16 and average wait 0.0912 minutes. 17 and 18 positions are SECTION 28's whole positions run at availability 1, and 14 positions with 0.9850 minutes is the studio's opening carousel.")
