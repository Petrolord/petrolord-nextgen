...
q(2,
 ...
 "The engine's model string is Q_TNT = alpha_e Qf Emf / Em_TNT and the digest prints 2980.434783 kg against a yield factor of 0.1. 596.086957, 1192.173913 and 5960.869565 kg are the rows for 0.02, 0.04 and 0.2: each is the right arithmetic at a different stated yield, and the TNT mass is linear in the yield, so reading the wrong row moves the answer in proportion."),

q(0,
 "On the same BONGA cloud, which stated yield factor produces the TNT equivalent mass of 1192.173913 kg?",
 "0.04",
 ["0.02", "0.1", "0.2"],
 "The digest's table pairs 1192.173913 kg with a yield factor of 0.04. The yield of 0.02 gives 596.086957 kg, 0.1 gives 2980.434783 kg and 0.2 gives 5960.869565 kg. The yield is the caller's input; the Yellow Book reports 0.02 to 0.2 in use, and the engine carries no default for it."),
...
q(1,
 "Section 32 plants the same mistake in the engine and its oracle and asks what still catches it. What does it say catches a mistake in the TNT equivalence?",
...
q(2,
 "The digest runs eight times BONGA's 500 kg charge at twice 100 m. What overpressure does the engine print for that case?",
 "7457.699887 Pa",
...
q(3,
 "In the digest's table of the ratio over ambient against Z, what overpressure in Pa does the Kinney and Graham fit give at Z = 5?",
 "29238.106780 Pa",
 ["9985.363723 Pa",
  "207926.999232 Pa",
