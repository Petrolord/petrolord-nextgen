...
q(1,
 ...
 "Air at 15 C is about twice the printed value, which makes this an erratum in the source. The golden uses the printed value because the printed tilt depends on it, and its effect is small because Re enters as a power of 0.117. The engine has no default viscosity at all, and the reason given is the tilt, with no claim about the heat flux tolerance.")
