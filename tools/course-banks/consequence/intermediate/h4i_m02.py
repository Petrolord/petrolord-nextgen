...
q(1,
 ...
 "The still air form L/D = 42 (m\" / (rho_air sqrt(g D)))^0.61 gives ERHA a flame length of 37.101102 m. 35.746382 m is Thomas with wind at a wind below the characteristic speed, a different correlation. 32.511563 m is Thomas with wind at 4 m/s. 46.775288 m is the Yellow Book benzene pool fire, a different fire.")
...
q(0,
 ...
 "The course shows uc = 2.546226 m/s for ERHA. 3.068751 m/s is the characteristic wind speed of the Yellow Book benzene fire, a different pool. 1.570953 is ERHA's scaled wind speed u* at 4 m/s, a ratio with no unit. 1.629327 is the scaled wind speed of the Yellow Book example.")
...
q(2,
 ...
 "The course states the wind form at no wind (35.746382 m) is a different correlation from the still air form (37.101102 m): the constants 55 and 0.67 against 42 and 0.61. The method is named in every call and the two are not interchangeable. The wind form holds u* at one and does not refuse a zero wind, and 1.570953 is u* at 4 m/s, unrelated to this comparison.")
...
q(3,
 ...
 "The engine's string reads \"Thomas with wind: L/D = 55 (m\" / (rho_air sqrt(g D)))^0.67 u*^-0.21, u* = max(1, u10 / uc)\". 42 with 0.61 is the still air form. 0.666 with 0.333 and 0.117 are the tilt correlation. 140e3 and 20e3 with exp(-0.12 D) are Mudan's surface emissive power.")
...
q(1,
 ...
 "The course's engine note says the consequence engine imports the still air Thomas flame height from engines/facilities/spacing.js and restates none of its helpers, and the course repeats that the expression is imported. A golden is test data and is never read at run time. Setting u* to one in the wind form gives 35.746382 m for ERHA, a different number from the still air 37.101102 m.")

q(2,
 "The course lists Thomas in still air among the single route quantities. What does a capstone in this course do about it?",
...
q(0,
 ...
 "The course gives uc = (g m\" D / rho_air)^(1/3): gravity, the burning flux, the diameter and the air density. The wind and the viscosity enter the tilt through the Froude and Reynolds numbers. The flame length and tilt are outputs downstream of uc, and the heat of combustion with the radiative fraction set the surface emissive power.")
...
q(3,
 ...
 "The course lists it: \"burningFluxKgM2S: must be a burning flux above 0 kg/(m2 s)\". The engine returns a result or a refusal, so a zero length with a warning is not what it does, and it never swaps a named method. The fuel refusal belongs to poolBurningRate, a different function.")

q(1,
 "How long is the ERHA flame, in metres, by the wind correlation when the breeze is 4 m/s?",
 "32.511563",
 ["28.107457","35.746382","37.101102"],
 "The 4 m/s row prints u* 1.570953, L/D 1.625578 and a flame length of 32.511563 m, the length the course then carries into the surface emissive power. 28.107457 m belongs to 8 m/s. 35.746382 m is the held length below uc. 37.101102 m is the still air form.")
