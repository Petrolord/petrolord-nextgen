...
q(0,
 ...
 ["Rename spend to cost, because the word cost is on the preferred alias list as cost_usd and the engine matches on the word, not the suffix.",
...
q(2,
 ...
 "Nothing: the run proceeds with total opex 0.00, because the refusals check that a recognised header exists, not that opex is present or that the number under it is right.",
