...
q(0,
 ...
 ["One reader used the Regulations price royalty benchmarks, which overstate the royalty and pull the NPV down by the difference between the two.",
  "One reader ran the ledger on the nominal basis and the other on the real one, and the 3 percent inflation accounts for the gap.",
...
q(1,
 "AKATA as a new lease with prior cumulative 0 and as a new lease with prior cumulative 96000000, both run at a stated new-PML hydrocarbon tax rate, print identical 2029 rows: allowance 17600000.00 on 2200000.00 eligible bbl with the cap flag false. How does a reader tell the two runs apart?",
 "Only from the totals: the allowance is 77440000.00 over the life in one and 54720000.00 in the other, because the cap is crossed later.",
 ...
 "After the cap every later barrel still earns the lower after-cap allowance, which is why the second total is lower yet well above zero. The allowance does not depend on the stated rate; a converted lease earns 5500000.00 in 2029 and 24200000.00 over the life.")
