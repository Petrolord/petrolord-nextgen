...
q(0,
 ...
 "A take above 100 percent is a royalty on a loss, not an error; at 45 USD/bbl it reads 247.7770 percent for the same reason.")
...
q(2,
 "On the published oil_price_multiyear_pia_real sweep the take reads 144.0232 percent at 40 USD/bbl, 71.1024 at 80 and 71.3286 at 120, while AKATA's JV take falls from 87.4083 at 60 to 57.9418 at 120. Why does the PIA take hold almost flat?",
...
q(3,
 ...
 ["The average must be taken over the discounted flows before the ledger is summed, not over the NPVs afterwards.",
...
q(0,
 "At a nominal discount rate of 0 percent AKATA's rate sweep prints NPV 141637829.18, the nominal total, not the real total 117362408.71, and an applied real rate of -2.912621 percent. Why?",
...
q(2,
 ...
 "The published cases leave the same trace, -243.53 on jv_analytic, 810.98 on pia_worked_example and 851.16 on multiyear_pia_real, and the IRR of 10.0002 percent confirms the crossing was found.")
...
q(3,
 "On decline_rate_multiyear_pia at 20 percent decline the limit year is 2030, four years are trimmed and six rows are valued. What does the sweep refuse to do with the trimmed years?",
 "Keep them: a year that fails the limit test is removed from the valued ledger, not carried at zero, and the KPIs are of the shortened field.",
 ["Report them at all, so the rows column reads 10 on every point and only the KPIs reveal the trimming, because the row count is fixed by the production upload and the limit test only zeroes the values in the years it fails.",
  "Charge their opex, so the KPIs of the shortened field carry no cost after the limit year, while the revenue of the trimmed years is still counted inside the total of 1532137562.53.",
  "Discount them, so they enter the NPV at face value and pull the NPV down to -76483227.81, because a year past the limit is carried undiscounted as a liability instead of being removed from the ledger."],
...
q(0,
 "The decline sweep reports a take of 1199.4096 percent at 40 percent decline and a unit technical cost of 78.666122 USD/boe. What is the 1199.4096?",
 ...
 ["A rounding fault in the take, which the engine should have reported as null once the residual turned negative as it does on AKATA at 40 USD/bbl.",
  "The royalties of 118324626.82 divided by the three surviving rows of revenue, which is how the take is defined once the limit engages.",
  "The take on the ten-year field before trimming, carried forward unchanged because the take is an undiscounted reading."],
 "Take is 105.7792 percent at 20 percent decline and 202.4061 at 30: the denominator shrinks toward zero as rows are cut, and a share of a value near zero is a large percentage.")
