...
--   spreadsheet work. The three risked fields are a seeded run of the Suite
--   canonical sampler: the prompt now points at W3's case file (Suite #568),
--   which the Well Cost and Time Estimator imports and runs at seed 20260904 and
--   prints at full precision behind its Full precision switch (W3 verified all
--   16 keys through wctRun, wctFullPrecision.test.jsx). This file must not go
--   live before the Suite zip carrying #554 to #568.
...
--   place of the provision. The same case, with these ranges in this order, seed
--   20260904 and 20000 iterations, is the Suite case file
--   https://petrolord.com/course-cases/wellcost-merlin-a12-advanced.wct.json: in
--   the Well Cost and Time Estimator pick a wellbore, choose Import case and
--   that file, open the Risk tab, run the Monte Carlo and switch on Full
--   precision to read fields 4 to 6.
...
begin
  ...
  select case when md5(prompt) = 'b69a50af2b724b0e81f8aad16ea66197' and fields = '[{"key": "curve_at_int_casing_usd", "tol": 2, "unit": "USD", "label": "Curve at intermediate casing", "expected": 5421894.326682938}, {"key": "curve_at_evaluation_usd", "tol": 5, "unit": "USD", "label": "Curve at evaluation", "expected": 11152431.73458189}, {"key": "curve_final_usd", "tol": 8, "unit": "USD", "label": "Curve final point", "expected": 15385809.811338803}, {"key": "mc_cost_p10_usd", "tol": 8, "unit": "USD", "label": "Risked cost, P10", "expected": 15111064.647716}, {"key": "mc_cost_p90_usd", "tol": 10, "unit": "USD", "label": "Risked cost, P90", "expected": 17776363.724421192}, {"key": "mc_days_p50", "tol": 0.00003, "unit": "d", "label": "Risked days, P50", "expected": 49.37724886122158}]'::jsonb then 'old'
              when md5(prompt) = '88caee77d01214ac071c2a837de0dade' and fields = '[{"key": "curve_at_int_casing_usd", "tol": 2, "unit": "USD", "label": "Curve at intermediate casing", "expected": 5421894.326682938}, {"key": "curve_at_evaluation_usd", "tol": 5, "unit": "USD", "label": "Curve at evaluation", "expected": 11152431.73458189}, {"key": "curve_final_usd", "tol": 8, "unit": "USD", "label": "Curve final point", "expected": 15385809.811338803}, {"key": "mc_cost_p10_usd", "tol": 8, "unit": "USD", "label": "Risked cost, P10", "expected": 15111064.647716}, {"key": "mc_cost_p90_usd", "tol": 10, "unit": "USD", "label": "Risked cost, P90", "expected": 17776363.724421192}, {"key": "mc_days_p50", "tol": 0.00003, "unit": "d", "label": "Risked days, P50", "expected": 49.37724886122158}]'::jsonb then 'new'
              else 'other' end
    into v_s2 from public.academy_capstones where app_slug = 'wellcost' and tier = 'advanced' and active;
  if v_s2 = 'other' then
    raise exception 'w2 wellcost refused: wellcost/advanced matches neither its published form (prompt md5 b69a50af2b724b0e81f8aad16ea66197) nor its W2 form (prompt md5 88caee77d01214ac071c2a837de0dade), with the fields this file was generated against';
  end if;
